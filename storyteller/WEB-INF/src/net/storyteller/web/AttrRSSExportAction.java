...
public class AttrRSSExportAction extends Action{
...
//	    		##secoundclass## ##secoundobj## = attr.get##secoundclass##();
...
//	    			criteria.add(Restrictions.eq("##secoundobj##", ##secoundobj##));
	    			...
	    			ChannelIF newChannel = builder.createChannel("Attrs");
	    			...
	    			newChannel.setDescription("Attrs");
	    			...
	    			PrintWriter printWriter = new PrintWriter(new File(this.getServlet().getServletContext().getRealPath("AttrRssExport.xml")),"utf-8");
