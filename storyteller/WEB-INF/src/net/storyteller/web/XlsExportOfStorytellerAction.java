...
public class XlsExportOfStorytellerAction {
	public XlsExportOfStorytellerAction(Vector vector,OutputStream outputStream,Session session){
        ...
        try{
    		...
    		for (Iterator iter = vector.iterator(); iter.hasNext();) {
    			...
    			sheet.addCell(new Label(x++, y, storyteller.get().getTypename()));
    			sheet.addCell(new Label(x++, y, storyteller.get().getModelcode()));
    			sheet.addCell(new Label(x++, y, storyteller.get().getShimuke()));
    			sheet.addCell(new Label(x++, y, storyteller.get().getName()));
    			sheet.addCell(new Number(x++, y, storyteller.get()));
    			sheet.addCell(new Number(x++, y, storyteller.get()));
