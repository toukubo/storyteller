...
public class XlsExportOfStrutsActionAction {
	public XlsExportOfStrutsActionAction(Vector vector,OutputStream outputStream,Session session){
        ...
        try{
    		...
    		for (Iterator iter = vector.iterator(); iter.hasNext();) {
    			...
    			sheet.addCell(new Label(x++, y, strutsaction.get().getTypename()));
    			sheet.addCell(new Label(x++, y, strutsaction.get().getModelcode()));
    			sheet.addCell(new Label(x++, y, strutsaction.get().getShimuke()));
    			sheet.addCell(new Label(x++, y, strutsaction.get().getName()));
    			sheet.addCell(new Number(x++, y, strutsaction.get()));
    			sheet.addCell(new Number(x++, y, strutsaction.get()));
