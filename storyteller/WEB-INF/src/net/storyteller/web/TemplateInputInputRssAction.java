...
public class TemplateInputInputRssAction extends Action{
	public ActionForward execute(
		...
		while(enum.hasMoreElements()){
		  ...
		  while(items.hasMoreElements()){
                  	RssChannelItem item = (RssChannelItem) items.nextElement();	     		                TemplateInput templateinput = new TemplateInputImpl();
			templateinput.setContent(item.getItemDescription());
			templateinput.setTitle(itemIf.getItemTitle());
