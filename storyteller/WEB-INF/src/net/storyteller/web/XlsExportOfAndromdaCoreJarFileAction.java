...
public class XlsExportOfAndromdaCoreJarFileAction {
	public XlsExportOfAndromdaCoreJarFileAction(Vector vector,OutputStream outputStream,Session session){
        ...
        try{
    		...
    		for (Iterator iter = vector.iterator(); iter.hasNext();) {
    			...
    			sheet.addCell(new Label(x++, y, andromdacorejarfile.get().getTypename()));
    			sheet.addCell(new Label(x++, y, andromdacorejarfile.get().getModelcode()));
    			sheet.addCell(new Label(x++, y, andromdacorejarfile.get().getShimuke()));
    			sheet.addCell(new Label(x++, y, andromdacorejarfile.get().getName()));
    			sheet.addCell(new Number(x++, y, andromdacorejarfile.get()));
    			sheet.addCell(new Number(x++, y, andromdacorejarfile.get()));
