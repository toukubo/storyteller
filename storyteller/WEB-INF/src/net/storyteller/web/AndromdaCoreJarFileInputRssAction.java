...
public class AndromdaCoreJarFileInputRssAction extends Action{
	public ActionForward execute(
		...
		while(enum.hasMoreElements()){
		  ...
		  while(items.hasMoreElements()){
                  	RssChannelItem item = (RssChannelItem) items.nextElement();	     		                AndromdaCoreJarFile andromdacorejarfile = new AndromdaCoreJarFileImpl();
			andromdacorejarfile.setContent(item.getItemDescription());
			andromdacorejarfile.setTitle(itemIf.getItemTitle());
