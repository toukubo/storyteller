...
public class XlsExportOfJspAction {
	public XlsExportOfJspAction(Vector vector,OutputStream outputStream,Session session){
        ...
        try{
    		...
    		for (Iterator iter = vector.iterator(); iter.hasNext();) {
    			...
    			sheet.addCell(new Label(x++, y, jsp.get().getTypename()));
    			sheet.addCell(new Label(x++, y, jsp.get().getModelcode()));
    			sheet.addCell(new Label(x++, y, jsp.get().getShimuke()));
    			sheet.addCell(new Label(x++, y, jsp.get().getName()));
    			sheet.addCell(new Number(x++, y, jsp.get()));
    			sheet.addCell(new Number(x++, y, jsp.get()));
