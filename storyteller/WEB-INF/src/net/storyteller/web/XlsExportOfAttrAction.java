...
public class XlsExportOfAttrAction {
	public XlsExportOfAttrAction(Vector vector,OutputStream outputStream,Session session){
        ...
        try{
    		...
    		for (Iterator iter = vector.iterator(); iter.hasNext();) {
    			...
    			sheet.addCell(new Label(x++, y, attr.get().getTypename()));
    			sheet.addCell(new Label(x++, y, attr.get().getModelcode()));
    			sheet.addCell(new Label(x++, y, attr.get().getShimuke()));
    			sheet.addCell(new Label(x++, y, attr.get().getName()));
    			sheet.addCell(new Number(x++, y, attr.get()));
    			sheet.addCell(new Number(x++, y, attr.get()));
