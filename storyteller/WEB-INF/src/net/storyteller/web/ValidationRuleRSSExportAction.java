...
public class ValidationRuleRSSExportAction extends Action{
...
//	    		##secoundclass## ##secoundobj## = validationrule.get##secoundclass##();
	    			criteria = session.createCriteria(ValidationRule.class);
...
//	    			criteria.add(Restrictions.eq("##secoundobj##", ##secoundobj##));
	    			...
	    			ChannelIF newChannel = builder.createChannel("ValidationRules");
	    			...
	    			newChannel.setDescription("ValidationRules");
					...
					//item.setDate(new Date());
	    				...
	    				item.setTitle(validationrule.getName());
	    				item.setLink(new URL("http://"+req.getServerName()+req.getRequestURI());
	    				item.setDescription(validationrule.getName());
	    			...
	    			PrintWriter printWriter = new PrintWriter(new File(this.getServlet().getServletContext().getRealPath("ValidationRuleRssExport.xml")),"utf-8");
