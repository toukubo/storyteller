...
public class VerbRSSExportAction extends Action{
...
//	    		##secoundclass## ##secoundobj## = verb.get##secoundclass##();
	    			criteria = session.createCriteria(Verb.class);
...
//	    			criteria.add(Restrictions.eq("##secoundobj##", ##secoundobj##));
	    			...
	    			ChannelIF newChannel = builder.createChannel("Verbs");
	    			...
	    			newChannel.setDescription("Verbs");
	    			...
	    			PrintWriter printWriter = new PrintWriter(new File(this.getServlet().getServletContext().getRealPath("VerbRssExport.xml")),"utf-8");
