...
public class NounUseInputRssAction extends Action{
	public ActionForward execute(
		...
		while(enum.hasMoreElements()){
		  ...
		  while(items.hasMoreElements()){
                  	RssChannelItem item = (RssChannelItem) items.nextElement();	     		                NounUse nounuse = new NounUseImpl();
			nounuse.setContent(item.getItemDescription());
			nounuse.setTitle(itemIf.getItemTitle());
