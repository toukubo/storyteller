...
public class StrutsActionTemplateRSSExportAction extends Action{
...
//	    		##secoundclass## ##secoundobj## = strutsactiontemplate.get##secoundclass##();
...
//	    			criteria.add(Restrictions.eq("##secoundobj##", ##secoundobj##));
	    			...
	    			ChannelIF newChannel = builder.createChannel("StrutsActionTemplates");
	    			...
	    			newChannel.setDescription("StrutsActionTemplates");
					...
					//item.setDate(new Date());
	    				...
	    				item.setTitle(strutsactiontemplate.getName());
	    				item.setLink(new URL("http://"+req.getServerName()+req.getRequestURI());
	    				item.setDescription(strutsactiontemplate.getName());
	    			...
	    			PrintWriter printWriter = new PrintWriter(new File(this.getServlet().getServletContext().getRealPath("StrutsActionTemplateRssExport.xml")),"utf-8");
