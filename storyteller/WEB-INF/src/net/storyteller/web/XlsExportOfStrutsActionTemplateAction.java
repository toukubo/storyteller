...
public class XlsExportOfStrutsActionTemplateAction {
	public XlsExportOfStrutsActionTemplateAction(Vector vector,OutputStream outputStream,Session session){
        ...
        try{
    		...
    		for (Iterator iter = vector.iterator(); iter.hasNext();) {
    			...
    			sheet.addCell(new Label(x++, y, strutsactiontemplate.get().getTypename()));
    			sheet.addCell(new Label(x++, y, strutsactiontemplate.get().getModelcode()));
    			sheet.addCell(new Label(x++, y, strutsactiontemplate.get().getShimuke()));
    			sheet.addCell(new Label(x++, y, strutsactiontemplate.get().getName()));
    			sheet.addCell(new Number(x++, y, strutsactiontemplate.get()));
    			sheet.addCell(new Number(x++, y, strutsactiontemplate.get()));
