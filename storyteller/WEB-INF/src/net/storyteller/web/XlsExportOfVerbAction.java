	...
	public XlsExportOfVerbAction(Vector vector,OutputStream outputStream,Session session){
        ...
        try{
    		...
    		for (Iterator iter = vector.iterator(); iter.hasNext();) {
    			...
    			sheet.addCell(new Label(x++, y, verb.get().getTypename()));
    			sheet.addCell(new Label(x++, y, verb.get().getModelcode()));
    			sheet.addCell(new Label(x++, y, verb.get().getShimuke()));
    			sheet.addCell(new Label(x++, y, verb.get().getName()));
    			sheet.addCell(new Number(x++, y, verb.get()));
    			sheet.addCell(new Number(x++, y, verb.get()));
