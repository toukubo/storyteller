...
public class JspInputRssAction extends Action{
	public ActionForward execute(
		...
		while(enum.hasMoreElements()){
		  ...
		  while(items.hasMoreElements()){
                  	RssChannelItem item = (RssChannelItem) items.nextElement();	     		                Jsp jsp = new JspImpl();
			jsp.setContent(item.getItemDescription());
			jsp.setTitle(itemIf.getItemTitle());
