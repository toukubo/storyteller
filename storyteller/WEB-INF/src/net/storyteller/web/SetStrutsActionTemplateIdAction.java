...
public class SetStrutsActionTemplateIdAction extends Action{
	public ActionForward execute(
		...
		new HTTPGetRedirection(req, res, "StrutsActionTemplates.do", strutsactiontemplate.getId().toString());
		return null;
