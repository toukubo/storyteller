...
public class StorytellerInputRssAction extends Action{
	public ActionForward execute(
		...
		while(enum.hasMoreElements()){
		  ...
		  while(items.hasMoreElements()){
                  	RssChannelItem item = (RssChannelItem) items.nextElement();	     		                Storyteller storyteller = new StorytellerImpl();
			storyteller.setContent(item.getItemDescription());
			storyteller.setTitle(itemIf.getItemTitle());
