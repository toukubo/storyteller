...
public class J2eeStoryInputRssAction extends Action{
	public ActionForward execute(
		...
		while(enum.hasMoreElements()){
		  ...
		  while(items.hasMoreElements()){
                  	RssChannelItem item = (RssChannelItem) items.nextElement();	     		                J2eeStory j2eestory = new J2eeStoryImpl();
			j2eestory.setContent(item.getItemDescription());
			j2eestory.setTitle(itemIf.getItemTitle());
