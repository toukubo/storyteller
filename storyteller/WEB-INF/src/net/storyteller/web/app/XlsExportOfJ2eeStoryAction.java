...
//        sheet.addCell(new Label(x++, 0, "andromdaCoreJarFile"));
        ...
        sheet.addCell(new Number(x++,y,j2eeStory.getId().intValue()));
...
//        sheet.addCell(new Label(x++,y,j2eeStory.getAndromdaCoreJarFile().getName()));
        ...
        if(j2eeStory.getContribute()!=null){

        	sheet.addCell(new Number(x++,y,j2eeStory.getContribute().getId().intValue()));
