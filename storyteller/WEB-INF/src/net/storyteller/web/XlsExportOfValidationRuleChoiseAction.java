...
public class XlsExportOfValidationRuleChoiseAction{
	public XlsExportOfValidationRuleChoiseAction(Vector vector,OutputStream outputStream,Session session){
        ...
        try{
    		...
    		for (Iterator iter = vector.iterator(); iter.hasNext();) {
    			...
    			sheet.addCell(new Label(x++, y, validationrulechoise.get().getTypename()));
    			sheet.addCell(new Label(x++, y, validationrulechoise.get().getModelcode()));
    			sheet.addCell(new Label(x++, y, validationrulechoise.get().getShimuke()));
    			sheet.addCell(new Label(x++, y, validationrulechoise.get().getName()));
    			sheet.addCell(new Number(x++, y, validationrulechoise.get()));
    			sheet.addCell(new Number(x++, y, validationrulechoise.get()));
