...
public class XlsExportOfNounAction {
	public XlsExportOfNounAction(Vector vector,OutputStream outputStream,Session session){
        ...
        try{
    		...
    		for (Iterator iter = vector.iterator(); iter.hasNext();) {
    			...
    			sheet.addCell(new Label(x++, y, noun.get().getTypename()));
    			sheet.addCell(new Label(x++, y, noun.get().getModelcode()));
    			sheet.addCell(new Label(x++, y, noun.get().getShimuke()));
    			sheet.addCell(new Label(x++, y, noun.get().getName()));
    			sheet.addCell(new Number(x++, y, noun.get()));
    			sheet.addCell(new Number(x++, y, noun.get()));
