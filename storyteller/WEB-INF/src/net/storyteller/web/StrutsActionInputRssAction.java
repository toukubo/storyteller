...
public class StrutsActionInputRssAction extends Action{
	public ActionForward execute(
		...
		while(enum.hasMoreElements()){
		  ...
		  while(items.hasMoreElements()){
                  	RssChannelItem item = (RssChannelItem) items.nextElement();	     		                StrutsAction strutsaction = new StrutsActionImpl();
			strutsaction.setContent(item.getItemDescription());
			strutsaction.setTitle(itemIf.getItemTitle());
