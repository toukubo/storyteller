...
public class JspTemplateInputRssAction extends Action{
	public ActionForward execute(
		...
		while(enum.hasMoreElements()){
		  ...
		  while(items.hasMoreElements()){
                  	RssChannelItem item = (RssChannelItem) items.nextElement();	     		                JspTemplate jsptemplate = new JspTemplateImpl();
			jsptemplate.setContent(item.getItemDescription());
			jsptemplate.setTitle(itemIf.getItemTitle());
