...
public class NounInputRssAction extends Action{
	public ActionForward execute(
		...
		while(enum.hasMoreElements()){
		  ...
		  while(items.hasMoreElements()){
                  	RssChannelItem item = (RssChannelItem) items.nextElement();	     		                Noun noun = new NounImpl();
			noun.setContent(item.getItemDescription());
			noun.setTitle(itemIf.getItemTitle());
