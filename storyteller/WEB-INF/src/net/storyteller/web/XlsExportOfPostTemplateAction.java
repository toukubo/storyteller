...
public class XlsExportOfPostTemplateAction {
	public XlsExportOfPostTemplateAction(Vector vector,OutputStream outputStream,Session session){
        ...
        try{
    		...
    		for (Iterator iter = vector.iterator(); iter.hasNext();) {
    			PostTemplate posttemplate = (PostTemplate) iter.next();
    			sheet.addCell(new Label(x++, y, posttemplate.get().getTypename()));
    			sheet.addCell(new Label(x++, y, posttemplate.get().getModelcode()));
    			sheet.addCell(new Label(x++, y, posttemplate.get().getShimuke()));
    			sheet.addCell(new Label(x++, y, posttemplate.get().getName()));
    			sheet.addCell(new Number(x++, y, posttemplate.get()));
    			sheet.addCell(new Number(x++, y, posttemplate.get()));
