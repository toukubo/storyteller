...
public class StrutsActionTemplateInputRssAction extends Action{
	public ActionForward execute(
		...
		while(enum.hasMoreElements()){
		  ...
		  while(items.hasMoreElements()){
                  	RssChannelItem item = (RssChannelItem) items.nextElement();	     		                StrutsActionTemplate strutsactiontemplate = new StrutsActionTemplateImpl();
			strutsactiontemplate.setContent(item.getItemDescription());
			strutsactiontemplate.setTitle(itemIf.getItemTitle());
