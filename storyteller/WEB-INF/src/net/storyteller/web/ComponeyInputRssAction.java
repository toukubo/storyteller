...
public class ComponeyInputRssAction extends Action{
	public ActionForward execute(
		...
		while(enum.hasMoreElements()){
		  ...
		  while(items.hasMoreElements()){
                  	RssChannelItem item = (RssChannelItem) items.nextElement();	     		                Componey componey = new ComponeyImpl();
			componey.setContent(item.getItemDescription());
			componey.setTitle(itemIf.getItemTitle());
