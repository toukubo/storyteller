...
public class XlsExportOfTemplateInputAction {
	public XlsExportOfTemplateInputAction(Vector vector,OutputStream outputStream,Session session){
        ...
        try{
    		...
    		for (Iterator iter = vector.iterator(); iter.hasNext();) {
    			...
    			sheet.addCell(new Label(x++, y, templateinput.get().getTypename()));
    			sheet.addCell(new Label(x++, y, templateinput.get().getModelcode()));
    			sheet.addCell(new Label(x++, y, templateinput.get().getShimuke()));
    			sheet.addCell(new Label(x++, y, templateinput.get().getName()));
    			sheet.addCell(new Number(x++, y, templateinput.get()));
    			sheet.addCell(new Number(x++, y, templateinput.get()));
