...
public class AttrUseInputRssAction extends Action{
	public ActionForward execute(
		...
		while(enum.hasMoreElements()){
		  ...
		  while(items.hasMoreElements()){
                  	RssChannelItem item = (RssChannelItem) items.nextElement();	     		                AttrUse attruse = new AttrUseImpl();
			attruse.setContent(item.getItemDescription());
			attruse.setTitle(itemIf.getItemTitle());
