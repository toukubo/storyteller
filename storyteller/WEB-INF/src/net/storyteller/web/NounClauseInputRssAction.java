...
public class NounClauseInputRssAction extends Action{
	public ActionForward execute(
		...
		while(enum.hasMoreElements()){
		  ...
		  while(items.hasMoreElements()){
                  	RssChannelItem item = (RssChannelItem) items.nextElement();	     		                NounClause nounclause = new NounClauseImpl();
			nounclause.setContent(item.getItemDescription());
			nounclause.setTitle(itemIf.getItemTitle());
