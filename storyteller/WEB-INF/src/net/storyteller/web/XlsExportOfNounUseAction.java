...
public class XlsExportOfNounUseAction {
	public XlsExportOfNounUseAction(Vector vector,OutputStream outputStream,Session session){
        ...
        try{
    		...
    		for (Iterator iter = vector.iterator(); iter.hasNext();) {
    			...
    			sheet.addCell(new Label(x++, y, nounuse.get().getTypename()));
    			sheet.addCell(new Label(x++, y, nounuse.get().getModelcode()));
    			sheet.addCell(new Label(x++, y, nounuse.get().getShimuke()));
    			sheet.addCell(new Label(x++, y, nounuse.get().getName()));
    			sheet.addCell(new Number(x++, y, nounuse.get()));
    			sheet.addCell(new Number(x++, y, nounuse.get()));
