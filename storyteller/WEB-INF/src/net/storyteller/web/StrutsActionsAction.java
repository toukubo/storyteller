...
public class StrutsActionsAction extends Action{
	public ActionForward execute(
		...
		if (req.getParameter("id") != null
			...
			criteria2.add(Restrictions.idEq(Integer.valueOf(req
					.getParameter("id"))));
			strutsaction = (StrutsAction) criteria2.uniqueResult();
		...
		req.setAttribute("strutsaction",strutsaction);

		
		req.setAttribute("strutsactions",vector);
