...
public class ValidationRuleInputRssAction extends Action{
	public ActionForward execute(
		...
		while(enum.hasMoreElements()){
		  ...
		  while(items.hasMoreElements()){
                  	RssChannelItem item = (RssChannelItem) items.nextElement();	     		                ValidationRule validationrule = new ValidationRuleImpl();
			validationrule.setContent(item.getItemDescription());
			validationrule.setTitle(itemIf.getItemTitle());
