...
public class SentenceInputRssAction extends Action{
	public ActionForward execute(
		...
		while(enum.hasMoreElements()){
		  ...
		  while(items.hasMoreElements()){
                  	RssChannelItem item = (RssChannelItem) items.nextElement();	     		                Sentence sentence = new SentenceImpl();
			sentence.setContent(item.getItemDescription());
			sentence.setTitle(itemIf.getItemTitle());
