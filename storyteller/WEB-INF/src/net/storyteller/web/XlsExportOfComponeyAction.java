	...
	public XlsExportOfComponeyAction(Vector vector,OutputStream outputStream,Session session){
        ...
        try{
    		...
    		for (Iterator iter = vector.iterator(); iter.hasNext();) {
    			...
    			sheet.addCell(new Label(x++, y, componey.get().getTypename()));
    			sheet.addCell(new Label(x++, y, componey.get().getModelcode()));
    			sheet.addCell(new Label(x++, y, componey.get().getShimuke()));
    			sheet.addCell(new Label(x++, y, componey.get().getName()));
    			sheet.addCell(new Number(x++, y, componey.get()));
    			sheet.addCell(new Number(x++, y, componey.get()));
