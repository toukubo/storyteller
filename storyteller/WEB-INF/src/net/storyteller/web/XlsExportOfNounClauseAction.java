...
public class XlsExportOfNounClauseAction {
	public XlsExportOfNounClauseAction(Vector vector,OutputStream outputStream,Session session){
        ...
        try{
    		...
    		for (Iterator iter = vector.iterator(); iter.hasNext();) {
    			...
    			sheet.addCell(new Label(x++, y, nounclause.get().getTypename()));
    			sheet.addCell(new Label(x++, y, nounclause.get().getModelcode()));
    			sheet.addCell(new Label(x++, y, nounclause.get().getShimuke()));
    			sheet.addCell(new Label(x++, y, nounclause.get().getName()));
    			sheet.addCell(new Number(x++, y, nounclause.get()));
    			sheet.addCell(new Number(x++, y, nounclause.get()));
