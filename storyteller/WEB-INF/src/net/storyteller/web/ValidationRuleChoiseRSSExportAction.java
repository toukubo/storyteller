...
public class ValidationRuleChoiseRSSExportAction extends Action{
...
//	    		##secoundclass## ##secoundobj## = validationrulechoise.get##secoundclass##();
	    			criteria = session.createCriteria(ValidationRuleChoise.class);
...
//	    			criteria.add(Restrictions.eq("##secoundobj##", ##secoundobj##));
	    			...
	    			ChannelIF newChannel = builder.createChannel("ValidationRuleChoises");
	    			...
	    			newChannel.setDescription("ValidationRuleChoises");
					...
					//item.setDate(new Date());
	    				...
	    				item.setTitle(validationrulechoise.getName());
	    				item.setLink(new URL("http://"+req.getServerName()+req.getRequestURI());
	    				item.setDescription(validationrulechoise.getName());
	    			...
	    			PrintWriter printWriter = new PrintWriter(new File(this.getServlet().getServletContext().getRealPath("ValidationRuleChoiseRssExport.xml")),"utf-8");
