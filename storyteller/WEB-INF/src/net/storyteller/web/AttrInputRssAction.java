...
public class AttrInputRssAction extends Action{
	public ActionForward execute(
		...
		while(enum.hasMoreElements()){
		  ...
		  while(items.hasMoreElements()){
                  	RssChannelItem item = (RssChannelItem) items.nextElement();	     		                Attr attr = new AttrImpl();
			attr.setContent(item.getItemDescription());
			attr.setTitle(itemIf.getItemTitle());
