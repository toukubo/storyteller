...
public class SetTemplateInputNameAction extends Action{
	public ActionForward execute(
		...
		templateinput.setName(true);
		session.saveOrUpdate(templateinput);
		transaction.commit();
		session.flush();


		new HTTPGetRedirection(req, res, "TemplateInputs.do", templateinput.getId().toString());
		return null;
