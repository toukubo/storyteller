...
public class XlsExportOfJspTemplateAction{
	public XlsExportOfJspTemplateAction(Vector vector,OutputStream outputStream,Session session){
        ...
        try{
    		...
    		for (Iterator iter = vector.iterator(); iter.hasNext();) {
    			...
    			sheet.addCell(new Label(x++, y, jsptemplate.get().getTypename()));
    			sheet.addCell(new Label(x++, y, jsptemplate.get().getModelcode()));
    			sheet.addCell(new Label(x++, y, jsptemplate.get().getShimuke()));
    			sheet.addCell(new Label(x++, y, jsptemplate.get().getName()));
    			sheet.addCell(new Number(x++, y, jsptemplate.get()));
    			sheet.addCell(new Number(x++, y, jsptemplate.get()));
