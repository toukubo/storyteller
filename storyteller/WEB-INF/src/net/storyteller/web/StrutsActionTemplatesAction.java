...
public class StrutsActionTemplatesAction extends Action{
	public ActionForward execute(
		...
		for (Iterator iter = criteria.list().iterator(); iter.hasNext();) {
			...
			vector.add(strutsactiontemplate);
		}
		...
		if (req.getParameter("id") != null
			...
			criteria2.add(Restrictions.idEq(Integer.valueOf(req
					.getParameter("id"))));
			strutsactiontemplate = (StrutsActionTemplate) criteria2.uniqueResult();
		...
		req.setAttribute("strutsactiontemplates",vector);
