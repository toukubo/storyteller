...
public class NounRSSExportAction extends Action{
...
//	    		##secoundclass## ##secoundobj## = noun.get##secoundclass##();
...
//	    			criteria.add(Restrictions.eq("##secoundobj##", ##secoundobj##));
	    			...
	    			ChannelIF newChannel = builder.createChannel("Nouns");
	    			...
	    			newChannel.setDescription("Nouns");
	    			...
	    			PrintWriter printWriter = new PrintWriter(new File(this.getServlet().getServletContext().getRealPath("NounRssExport.xml")),"utf-8");
