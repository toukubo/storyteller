...
public class J2eeStoryRSSExportAction extends Action{
...
//	    		##secoundclass## ##secoundobj## = j2eestory.get##secoundclass##();
...
//	    			criteria.add(Restrictions.eq("##secoundobj##", ##secoundobj##));
	    			...
	    			ChannelIF newChannel = builder.createChannel("J2eeStorys");
	    			...
	    			newChannel.setDescription("J2eeStorys");
					...
					//item.setDate(new Date());
	    				...
	    				item.setTitle(j2eestory.getName());
	    				item.setLink(new URL("http://"+req.getServerName()+req.getRequestURI());
	    				item.setDescription(j2eestory.getName());
	    			...
	    			PrintWriter printWriter = new PrintWriter(new File(this.getServlet().getServletContext().getRealPath("J2eeStoryRssExport.xml")),"utf-8");
