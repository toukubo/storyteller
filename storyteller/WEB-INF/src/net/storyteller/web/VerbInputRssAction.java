...
public class VerbInputRssAction extends Action{
	public ActionForward execute(
		...
		while(enum.hasMoreElements()){
		  ...
		  while(items.hasMoreElements()){
                  	RssChannelItem item = (RssChannelItem) items.nextElement();	     		                Verb verb = new VerbImpl();
			verb.setContent(item.getItemDescription());
			verb.setTitle(itemIf.getItemTitle());
