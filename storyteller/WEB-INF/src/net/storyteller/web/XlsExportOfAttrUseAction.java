...
public class XlsExportOfAttrUseAction{
	public XlsExportOfAttrUseAction(Vector vector,OutputStream outputStream,Session session){
        ...
        try{
    		...
    		for (Iterator iter = vector.iterator(); iter.hasNext();) {
    			...
    			sheet.addCell(new Label(x++, y, attruse.get().getTypename()));
    			sheet.addCell(new Label(x++, y, attruse.get().getModelcode()));
    			sheet.addCell(new Label(x++, y, attruse.get().getShimuke()));
    			sheet.addCell(new Label(x++, y, attruse.get().getName()));
    			sheet.addCell(new Number(x++, y, attruse.get()));
    			sheet.addCell(new Number(x++, y, attruse.get()));
