...
public class AndromdaCoreJarFileRSSExportAction extends Action{
...
//	    		##secoundclass## ##secoundobj## = andromdacorejarfile.get##secoundclass##();
	    			criteria = session.createCriteria(AndromdaCoreJarFile.class);
...
//	    			criteria.add(Restrictions.eq("##secoundobj##", ##secoundobj##));
	    			...
	    			ChannelIF newChannel = builder.createChannel("AndromdaCoreJarFiles");
	    			...
	    			newChannel.setDescription("AndromdaCoreJarFiles");
					...
					//item.setDate(new Date());
	    				...
	    				item.setTitle(andromdacorejarfile.getName());
	    				item.setLink(new URL("http://"+req.getServerName()+req.getRequestURI());
	    				item.setDescription(andromdacorejarfile.getName());
	    			...
	    			PrintWriter printWriter = new PrintWriter(new File(this.getServlet().getServletContext().getRealPath("AndromdaCoreJarFileRssExport.xml")),"utf-8");
