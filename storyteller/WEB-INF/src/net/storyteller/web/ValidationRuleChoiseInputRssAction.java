...
public class ValidationRuleChoiseInputRssAction extends Action{
	public ActionForward execute(
		...
		while(enum.hasMoreElements()){
		  ...
		  while(items.hasMoreElements()){
                  	RssChannelItem item = (RssChannelItem) items.nextElement();	     		                ValidationRuleChoise validationrulechoise = new ValidationRuleChoiseImpl();
			validationrulechoise.setContent(item.getItemDescription());
			validationrulechoise.setTitle(itemIf.getItemTitle());
