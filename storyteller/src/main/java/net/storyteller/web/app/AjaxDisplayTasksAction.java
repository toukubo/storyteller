...
public class AjaxDisplayTasksAction extends Action{
...
Criteria criteriaTaskTemplate= session.createCriteria(TaskTemplate.class);
			req.setAttribute("TaskTemplates", criteriaTaskTemplate.list());
