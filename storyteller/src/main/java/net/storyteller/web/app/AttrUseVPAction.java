...
public class AttrUseVPAction extends Action{
	public ActionForward execute(
		...
		criteria.add(Restrictions.eq("attr", attr));
		criteria.add(Restrictions.eq("nounUse", nounuse));
		...
		new HTTPGetRedirection(req, res, "J2eeStoryDetail.do", attruse.getNounUse().getNoun().getJ2eeStory().getId().toString());
		return null;
