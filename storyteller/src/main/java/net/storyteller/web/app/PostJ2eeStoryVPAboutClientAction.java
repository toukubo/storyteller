...
public class PostJ2eeStoryVPAboutClientAction extends Action{
...
if(StringUtils.isNotBlank(error)){
	...
	return mapping.findForward("error");
                		...
                		Integer clientInt = j2eeStoryform.getClient();
		j2eeStoryform.setClient(null);
