...
public class PostEstimationVPAction extends Action{
	public ActionForward execute(
		...
		estimation.setTitle(estimationform.getTitle());
		...
		new HTTPGetRedirection(req, res, "AjaxDisplayEstimations.do", null);
		return null;
