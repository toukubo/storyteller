...
public class JspTemplatesAction extends Action{
	public ActionForward execute(
		...
		if (req.getParameter("id") != null
			...
			criteria2.add(Restrictions.idEq(Integer.valueOf(req
					.getParameter("id"))));
			jsptemplate = (JspTemplate) criteria2.uniqueResult();
		...
		req.setAttribute("jsptemplates",vector);
