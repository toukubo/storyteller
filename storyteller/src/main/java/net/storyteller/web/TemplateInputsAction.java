...
public class TemplateInputsAction extends Action{
	public ActionForward execute(
		...
		if (req.getParameter("id") != null
			...
			criteria2.add(Restrictions.idEq(Integer.valueOf(req
					.getParameter("id"))));
			templateinput = (TemplateInput) criteria2.uniqueResult();
		...
		req.setAttribute("templateinputs",vector);
