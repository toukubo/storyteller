...
<nobr><input size="8" onblur="ajax(${row.id});" type="text" name="cyclename" id="${row.id}_cyclename" value="${row.cyclename}" /></nobr>
</display:column>
 <display:column media="html" sortable="true" title="周期的">
<nobr><input size="8" onblur="ajax(${row.id});" type="text" name="cycle" id="${row.id}_cycle" value="${row.cycle}" /></nobr>
</display:column>
 <display:column media="html" sortable="true" title="機材">
<nobr><input size="8" onblur="ajax(${row.id});" type="text" name="equipment" id="${row.id}_equipment" value="${row.equipment}" /></nobr>
</display:column>
