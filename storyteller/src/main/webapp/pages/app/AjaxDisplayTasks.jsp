...
<nobr><input size="8"  type="text" name="done" id="${row.id}_done" value="${row.done}" /></nobr>
</display:column>
 <display:column media="html" sortable="true" title="開始日時"><nobr><input size="8"  type="text" name="startdateAsString" id="${row.id}_startdate" value="<st:date date="${row.basedeadline}"></st:date>" /></nobr>
</display:column>
 <display:column media="html" sortable="true" title="終了日時"><nobr><input size="8"  type="text" name="enddateAsString" id="${row.id}_enddate" value="<st:date date="${row.basedeadline}"></st:date>" /></nobr>
</display:column>
...
<nobr><input size="8"  type="text" name="assigned" id="${row.id}_assigned" value="${row.assigned}" /></nobr>
</display:column>
 <display:column media="html" sortable="true" title="TaskTemplate">
                                <c:choose>
                                    ...
                                    <c:otherwise>
<select  name="taskTemplate" id="${row.id}_taskTemplate"><option value=""></option>
...
<nobr><input size="8"  type="text" name="summery" id="${row.id}_summery" value="${row.summery}" /></nobr>
</display:column>
