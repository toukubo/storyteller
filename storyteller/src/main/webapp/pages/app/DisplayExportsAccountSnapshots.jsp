...
<display:column media="xml csv excel pdf" property="totalcost" title="totalcost"/>
<display:column media="xml csv excel pdf" property="capacityprice" title="capacityprice"/>
<display:column media="xml csv excel pdf" property="capacityleftprice" title="capacityleftprice"/>
