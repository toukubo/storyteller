...
java -cp "jp.storyteller.desktop.jar;../WEB-INF/lib/commons-httpclient-3.0.1.jar;../WEB-INF/lib/commons-logging.jar;../WEB-INF/lib/commons-codec-1.3.jar"  net.storyteller.desktop.HttpClientFilePostOfAndromdaCoreJarAddingToJ2eeStory http://localhost:8080/st c:/current/eclipse/workspace/ storyteller
