...
public class AttachmentFormFileUploadAddingToWorkAction extends Action{
	public ActionForward execute(
		...
		if(! (attachmentform.getFormFile().getFileName().endsWith(".jpg") || attachmentform.getFormFile().getFileName().endsWith(".JPG") || attachmentform.getFile().getFileName().endsWith(".JPEG") )){
