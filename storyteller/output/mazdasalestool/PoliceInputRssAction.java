...
public class PoliceInputRssAction extends Action{
	public ActionForward execute(
		...
		while(enum.hasMoreElements()){
		  ...
		  while(items.hasMoreElements()){
                  	RssChannelItem item = (RssChannelItem) items.nextElement();	     		                Police police = new PoliceImpl();
			police.setContent(item.getItemDescription());
			police.setTitle(itemIf.getItemTitle());
