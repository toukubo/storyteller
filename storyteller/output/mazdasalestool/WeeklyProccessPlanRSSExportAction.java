...
public class WeeklyProccessPlanRSSExportAction extends Action{
...
//	    		##secoundclass## ##secoundobj## = weeklyProccessPlan.get##secoundclass##();
...
//	    			criteria.add(Restrictions.eq("##secoundobj##", ##secoundobj##));
	    			...
	    			ChannelIF newChannel = builder.createChannel("WeeklyProccessPlans");
	    			...
	    			newChannel.setDescription("WeeklyProccessPlans");
					...
					//item.setDate(new Date());
	    				...
	    				item.setTitle(weeklyProccessPlan.getName());
	    				item.setLink(new URL("http://"+req.getServerName()+req.getRequestURI());
	    				item.setDescription(weeklyProccessPlan.getName());
	    			...
	    			PrintWriter printWriter = new PrintWriter(new File(this.getServlet().getServletContext().getRealPath("WeeklyProccessPlanRssExport.xml")),"utf-8");
