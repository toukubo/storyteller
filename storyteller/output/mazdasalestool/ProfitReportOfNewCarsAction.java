...
public class ProfitReportOfNewCarsAction extends Action{
	public ActionForward execute(
		...
		for (Iterator iter = criteria.list().iterator(); iter.hasNext();) {
			ProfitReportOfNewCar profitReportOfNewCar = (ProfitReportOfNewCar) iter.next();
			vector.add(profitReportOfNewCar);
		}
		...
		criteria = session.createCriteria(ProfitReportOfNewCar.class);
		...
		req.setAttribute("profitReportOfNewCars",vector);
