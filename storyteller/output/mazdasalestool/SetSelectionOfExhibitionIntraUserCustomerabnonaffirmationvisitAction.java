...
public class SetSelectionOfExhibitionIntraUserCustomerabnonaffirmationvisitAction extends Action{
	public ActionForward execute(
		...
		for (int I = 0; I < req.getParameterValues("id").length; i++) {
			...
			exhibitionIntraUser.setcustomerabnonaffirmationvisit(true);
