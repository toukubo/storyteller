...
public class ResultAndProductivityInputRssAction extends Action{
	public ActionForward execute(
		...
		while(enum.hasMoreElements()){
		  ...
		  while(items.hasMoreElements()){
                  	RssChannelItem item = (RssChannelItem) items.nextElement();	     		                ResultAndProductivity resultAndProductivity = new ResultAndProductivityImpl();
			resultAndProductivity.setContent(item.getItemDescription());
			resultAndProductivity.setTitle(itemIf.getItemTitle());
