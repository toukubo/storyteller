...
public class SetResultAndProductivityNonUsedotherintroductionemployeeAction extends Action{
	public ActionForward execute(
		...
		resultAndProductivity.setUsedotherintroductionemployee(false);
