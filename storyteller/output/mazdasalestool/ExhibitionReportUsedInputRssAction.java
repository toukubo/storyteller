...
public class ExhibitionReportUsedInputRssAction extends Action{
	public ActionForward execute(
		...
		while(enum.hasMoreElements()){
		  ...
		  while(items.hasMoreElements()){
                  	RssChannelItem item = (RssChannelItem) items.nextElement();	     		                ExhibitionReportUsed exhibitionReportUsed = new ExhibitionReportUsedImpl();
			exhibitionReportUsed.setContent(item.getItemDescription());
			exhibitionReportUsed.setTitle(itemIf.getItemTitle());
