...
public class WeeklyProccessPlanInputRssAction extends Action{
	public ActionForward execute(
		...
		while(enum.hasMoreElements()){
		  ...
		  while(items.hasMoreElements()){
                  	RssChannelItem item = (RssChannelItem) items.nextElement();	     		                WeeklyProccessPlan weeklyProccessPlan = new WeeklyProccessPlanImpl();
			weeklyProccessPlan.setContent(item.getItemDescription());
			weeklyProccessPlan.setTitle(itemIf.getItemTitle());
