...
public class XlsExportOfExhibitionReportUsedAction{
	public XlsExportOfExhibitionReportUsedAction(Vector vector,OutputStream outputStream,Session session){
        ...
        try{
    		...
    		for (Iterator iter = vector.iterator(); iter.hasNext();) {
    			...
    			sheet.addCell(new Label(x++, y, exhibitionReportUsed.get().getTypename()));
    			sheet.addCell(new Label(x++, y, exhibitionReportUsed.get().getModelcode()));
    			sheet.addCell(new Label(x++, y, exhibitionReportUsed.get().getShimuke()));
    			sheet.addCell(new Label(x++, y, exhibitionReportUsed.get().getName()));
    			sheet.addCell(new Number(x++, y, exhibitionReportUsed.get()));
    			sheet.addCell(new Number(x++, y, exhibitionReportUsed.get()));
