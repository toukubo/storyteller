...
public class ImprovementReportOfUsedCarProfitRSSExportAction extends Action{
...
//	    		##secoundclass## ##secoundobj## = improvementReportOfUsedCarProfit.get##secoundclass##();
...
//	    			criteria.add(Restrictions.eq("##secoundobj##", ##secoundobj##));
	    			...
	    			ChannelIF newChannel = builder.createChannel("ImprovementReportOfUsedCarProfits");
	    			...
	    			newChannel.setDescription("ImprovementReportOfUsedCarProfits");
					...
					//item.setDate(new Date());
	    				...
	    				item.setTitle(improvementReportOfUsedCarProfit.getName());
	    				item.setLink(new URL("http://"+req.getServerName()+req.getRequestURI());
	    				item.setDescription(improvementReportOfUsedCarProfit.getName());
	    			...
	    			PrintWriter printWriter = new PrintWriter(new File(this.getServlet().getServletContext().getRealPath("ImprovementReportOfUsedCarProfitRssExport.xml")),"utf-8");
