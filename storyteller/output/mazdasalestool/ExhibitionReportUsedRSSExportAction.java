...
public class ExhibitionReportUsedRSSExportAction extends Action{
...
//	    		##secoundclass## ##secoundobj## = exhibitionReportUsed.get##secoundclass##();
...
//	    			criteria.add(Restrictions.eq("##secoundobj##", ##secoundobj##));
	    			...
	    			ChannelIF newChannel = builder.createChannel("ExhibitionReportUseds");
	    			...
	    			newChannel.setDescription("ExhibitionReportUseds");
					...
					//item.setDate(new Date());
	    				...
	    				item.setTitle(exhibitionReportUsed.getName());
	    				item.setLink(new URL("http://"+req.getServerName()+req.getRequestURI());
	    				item.setDescription(exhibitionReportUsed.getName());
	    			...
	    			PrintWriter printWriter = new PrintWriter(new File(this.getServlet().getServletContext().getRealPath("ExhibitionReportUsedRssExport.xml")),"utf-8");
