...
public class SetExhibitionReportUsedNonVisitmotivationvisitaffirmationAction extends Action{
	public ActionForward execute(
		...
		exhibitionReportUsed.setVisitmotivationvisitaffirmation(false);
