...
public class ImprovementReportOfUsedCarProfitDetailAction extends Action{
	public ActionForward execute(
		...
		req.setAttribute("improvementReportOfUsedCarProfit",improvementReportOfUsedCarProfit);
