...
public class XlsExportOfExhibitionAction{
	public XlsExportOfExhibitionAction(Vector vector,OutputStream outputStream,Session session){
        ...
        try{
    		...
    		for (Iterator iter = vector.iterator(); iter.hasNext();) {
    			...
    			sheet.addCell(new Label(x++, y, exhibition.get().getTypename()));
    			sheet.addCell(new Label(x++, y, exhibition.get().getModelcode()));
    			sheet.addCell(new Label(x++, y, exhibition.get().getShimuke()));
    			sheet.addCell(new Label(x++, y, exhibition.get().getName()));
    			sheet.addCell(new Number(x++, y, exhibition.get()));
    			sheet.addCell(new Number(x++, y, exhibition.get()));
