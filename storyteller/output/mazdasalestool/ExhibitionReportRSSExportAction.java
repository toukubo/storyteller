...
public class ExhibitionReportRSSExportAction extends Action{
...
//	    		##secoundclass## ##secoundobj## = exhibitionReport.get##secoundclass##();
	    			criteria = session.createCriteria(ExhibitionReport.class);
...
//	    			criteria.add(Restrictions.eq("##secoundobj##", ##secoundobj##));
	    			...
	    			ChannelIF newChannel = builder.createChannel("ExhibitionReports");
	    			...
	    			newChannel.setDescription("ExhibitionReports");
					...
					//item.setDate(new Date());
	    				...
	    				item.setTitle(exhibitionReport.getName());
	    				item.setLink(new URL("http://"+req.getServerName()+req.getRequestURI());
	    				item.setDescription(exhibitionReport.getName());
	    			...
	    			PrintWriter printWriter = new PrintWriter(new File(this.getServlet().getServletContext().getRealPath("ExhibitionReportRssExport.xml")),"utf-8");
