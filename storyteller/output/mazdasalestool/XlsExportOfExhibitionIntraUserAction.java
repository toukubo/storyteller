...
public class XlsExportOfExhibitionIntraUserAction{
	public XlsExportOfExhibitionIntraUserAction(Vector vector,OutputStream outputStream,Session session){
        ...
        try{
    		...
    		for (Iterator iter = vector.iterator(); iter.hasNext();) {
    			...
    			sheet.addCell(new Label(x++, y, exhibitionIntraUser.get().getTypename()));
    			sheet.addCell(new Label(x++, y, exhibitionIntraUser.get().getModelcode()));
    			sheet.addCell(new Label(x++, y, exhibitionIntraUser.get().getShimuke()));
    			sheet.addCell(new Label(x++, y, exhibitionIntraUser.get().getName()));
    			sheet.addCell(new Number(x++, y, exhibitionIntraUser.get()));
    			sheet.addCell(new Number(x++, y, exhibitionIntraUser.get()));
