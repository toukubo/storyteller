...
public class ActionForSalessAction extends Action{
	public ActionForward execute(
		...
		if (req.getParameter("id") != null
			...
			criteria2.add(Restrictions.idEq(Integer.valueOf(req
					.getParameter("id"))));
			actionForSales = (ActionForSales) criteria2.uniqueResult();
		...
		req.setAttribute("actionForSales",actionForSales);

		
		req.setAttribute("actionForSaless",vector);
