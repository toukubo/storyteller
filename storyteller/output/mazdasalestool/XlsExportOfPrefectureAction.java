...
public class XlsExportOfPrefectureAction{
	public XlsExportOfPrefectureAction(Vector vector,OutputStream outputStream,Session session){
        ...
        try{
    		...
    		for (Iterator iter = vector.iterator(); iter.hasNext();) {
    			...
    			sheet.addCell(new Label(x++, y, prefecture.get().getTypename()));
    			sheet.addCell(new Label(x++, y, prefecture.get().getModelcode()));
    			sheet.addCell(new Label(x++, y, prefecture.get().getShimuke()));
    			sheet.addCell(new Label(x++, y, prefecture.get().getName()));
    			sheet.addCell(new Number(x++, y, prefecture.get()));
    			sheet.addCell(new Number(x++, y, prefecture.get()));
