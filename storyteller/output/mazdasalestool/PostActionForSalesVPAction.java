...
public class PostActionForSalesVPAction extends Action{
	public ActionForward execute(
		...
		session.flush();
		   ...
		   new HTTPGetRedirection(req, res, "PostActionForSalesDetail.do", actionForSales.getId().toString());
                }
