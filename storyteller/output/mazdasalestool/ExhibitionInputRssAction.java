...
public class ExhibitionInputRssAction extends Action{
	public ActionForward execute(
		...
		while(enum.hasMoreElements()){
		  ...
		  while(items.hasMoreElements()){
                  	RssChannelItem item = (RssChannelItem) items.nextElement();	     		                Exhibition exhibition = new ExhibitionImpl();
			exhibition.setContent(item.getItemDescription());
			exhibition.setTitle(itemIf.getItemTitle());
