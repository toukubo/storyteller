...
public class XlsExportOfPoliceAction{
	public XlsExportOfPoliceAction(Vector vector,OutputStream outputStream,Session session){
        ...
        try{
    		...
    		for (Iterator iter = vector.iterator(); iter.hasNext();) {
    			...
    			sheet.addCell(new Label(x++, y, police.get().getTypename()));
    			sheet.addCell(new Label(x++, y, police.get().getModelcode()));
    			sheet.addCell(new Label(x++, y, police.get().getShimuke()));
    			sheet.addCell(new Label(x++, y, police.get().getName()));
    			sheet.addCell(new Number(x++, y, police.get()));
    			sheet.addCell(new Number(x++, y, police.get()));
