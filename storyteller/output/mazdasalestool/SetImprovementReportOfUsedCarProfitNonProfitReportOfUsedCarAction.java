...
public class SetImprovementReportOfUsedCarProfitNonProfitReportOfUsedCarAction extends Action{
	public ActionForward execute(
		...
		improvementReportOfUsedCarProfit.setProfitReportOfUsedCar(false);
