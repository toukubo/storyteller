...
public class XlsExportOfActionForSalesAction{
	public XlsExportOfActionForSalesAction(Vector vector,OutputStream outputStream,Session session){
        ...
        try{
    		...
    		for (Iterator iter = vector.iterator(); iter.hasNext();) {
    			...
    			sheet.addCell(new Label(x++, y, actionForSales.get().getTypename()));
    			sheet.addCell(new Label(x++, y, actionForSales.get().getModelcode()));
    			sheet.addCell(new Label(x++, y, actionForSales.get().getShimuke()));
    			sheet.addCell(new Label(x++, y, actionForSales.get().getName()));
    			sheet.addCell(new Number(x++, y, actionForSales.get()));
    			sheet.addCell(new Number(x++, y, actionForSales.get()));
