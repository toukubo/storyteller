...
public class CarRSSExportAction extends Action{
...
//	    		##secoundclass## ##secoundobj## = car.get##secoundclass##();
...
//	    			criteria.add(Restrictions.eq("##secoundobj##", ##secoundobj##));
	    			...
	    			ChannelIF newChannel = builder.createChannel("Cars");
	    			...
	    			newChannel.setDescription("Cars");
					...
					//item.setDate(new Date());
	    				...
	    				item.setDescription(car.getName());
	    			...
	    			PrintWriter printWriter = new PrintWriter(new File(this.getServlet().getServletContext().getRealPath("CarRssExport.xml")),"utf-8");
