...
public class NavigationInputRssAction extends Action{
	public ActionForward execute(
		...
		while(enum.hasMoreElements()){
		  ...
		  while(items.hasMoreElements()){
                  	RssChannelItem item = (RssChannelItem) items.nextElement();	     		                Navigation navigation = new NavigationImpl();
			navigation.setContent(item.getItemDescription());
			navigation.setTitle(itemIf.getItemTitle());
