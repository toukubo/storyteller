...
public class SetSelectionOfExhibitionIntraUserCustomernonabaffirmationvisitAction extends Action{
	public ActionForward execute(
		...
		for (int I = 0; I < req.getParameterValues("id").length; i++) {
			...
			exhibitionIntraUser.setcustomernonabaffirmationvisit(true);
