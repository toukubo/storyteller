...
public class XlsExportOfNavigationAction{
	public XlsExportOfNavigationAction(Vector vector,OutputStream outputStream,Session session){
        ...
        try{
    		...
    		for (Iterator iter = vector.iterator(); iter.hasNext();) {
    			...
    			sheet.addCell(new Label(x++, y, navigation.get().getTypename()));
    			sheet.addCell(new Label(x++, y, navigation.get().getModelcode()));
    			sheet.addCell(new Label(x++, y, navigation.get().getShimuke()));
    			sheet.addCell(new Label(x++, y, navigation.get().getName()));
    			sheet.addCell(new Number(x++, y, navigation.get()));
    			sheet.addCell(new Number(x++, y, navigation.get()));
