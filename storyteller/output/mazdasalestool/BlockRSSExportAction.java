...
public class BlockRSSExportAction extends Action{
...
//	    		##secoundclass## ##secoundobj## = block.get##secoundclass##();
...
//	    			criteria.add(Restrictions.eq("##secoundobj##", ##secoundobj##));
	    			...
	    			ChannelIF newChannel = builder.createChannel("Blocks");
	    			...
	    			newChannel.setDescription("Blocks");
	    			...
	    			PrintWriter printWriter = new PrintWriter(new File(this.getServlet().getServletContext().getRealPath("BlockRssExport.xml")),"utf-8");
