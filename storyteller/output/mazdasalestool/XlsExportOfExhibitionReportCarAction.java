...
public class XlsExportOfExhibitionReportCarAction{
	public XlsExportOfExhibitionReportCarAction(Vector vector,OutputStream outputStream,Session session){
        ...
        try{
    		...
    		for (Iterator iter = vector.iterator(); iter.hasNext();) {
    			...
    			sheet.addCell(new Label(x++, y, exhibitionReportCar.get().getTypename()));
    			sheet.addCell(new Label(x++, y, exhibitionReportCar.get().getModelcode()));
    			sheet.addCell(new Label(x++, y, exhibitionReportCar.get().getShimuke()));
    			sheet.addCell(new Label(x++, y, exhibitionReportCar.get().getName()));
    			sheet.addCell(new Number(x++, y, exhibitionReportCar.get()));
    			sheet.addCell(new Number(x++, y, exhibitionReportCar.get()));
