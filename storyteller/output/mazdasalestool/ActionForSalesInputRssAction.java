...
public class ActionForSalesInputRssAction extends Action{
	public ActionForward execute(
		...
		while(enum.hasMoreElements()){
		  ...
		  while(items.hasMoreElements()){
                  	RssChannelItem item = (RssChannelItem) items.nextElement();	     		                ActionForSales actionForSales = new ActionForSalesImpl();
			actionForSales.setContent(item.getItemDescription());
			actionForSales.setTitle(itemIf.getItemTitle());
