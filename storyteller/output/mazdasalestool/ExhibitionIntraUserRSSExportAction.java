...
public class ExhibitionIntraUserRSSExportAction extends Action{
...
//	    		##secoundclass## ##secoundobj## = exhibitionIntraUser.get##secoundclass##();
...
//	    			criteria.add(Restrictions.eq("##secoundobj##", ##secoundobj##));
	    			...
	    			ChannelIF newChannel = builder.createChannel("ExhibitionIntraUsers");
	    			...
	    			newChannel.setDescription("ExhibitionIntraUsers");
					...
					//item.setDate(new Date());
	    				...
	    				item.setTitle(exhibitionIntraUser.getName());
	    				item.setLink(new URL("http://"+req.getServerName()+req.getRequestURI());
	    				item.setDescription(exhibitionIntraUser.getName());
	    			...
	    			PrintWriter printWriter = new PrintWriter(new File(this.getServlet().getServletContext().getRealPath("ExhibitionIntraUserRssExport.xml")),"utf-8");
