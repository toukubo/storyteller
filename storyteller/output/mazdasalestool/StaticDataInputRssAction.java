...
public class StaticDataInputRssAction extends Action{
	public ActionForward execute(
		...
		while(enum.hasMoreElements()){
		  ...
		  while(items.hasMoreElements()){
                  	RssChannelItem item = (RssChannelItem) items.nextElement();	     		                StaticData staticData = new StaticDataImpl();
			staticData.setContent(item.getItemDescription());
			staticData.setTitle(itemIf.getItemTitle());
