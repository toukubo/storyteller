...
public class CarInputRssAction extends Action{
	public ActionForward execute(
		...
		while(enum.hasMoreElements()){
		  ...
		  while(items.hasMoreElements()){
                  	RssChannelItem item = (RssChannelItem) items.nextElement();	     		                Car car = new CarImpl();
			car.setContent(item.getItemDescription());
			car.setTitle(itemIf.getItemTitle());
