...
public class BaseRSSExportAction extends Action{
...
//	    		##secoundclass## ##secoundobj## = base.get##secoundclass##();
	    			criteria = session.createCriteria(Base.class);
...
//	    			criteria.add(Restrictions.eq("##secoundobj##", ##secoundobj##));
	    			...
	    			ChannelIF newChannel = builder.createChannel("Bases");
	    			...
	    			newChannel.setDescription("Bases");
	    			...
	    			PrintWriter printWriter = new PrintWriter(new File(this.getServlet().getServletContext().getRealPath("BaseRssExport.xml")),"utf-8");
