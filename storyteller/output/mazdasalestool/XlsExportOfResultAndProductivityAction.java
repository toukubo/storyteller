...
public class XlsExportOfResultAndProductivityAction{
	public XlsExportOfResultAndProductivityAction(Vector vector,OutputStream outputStream,Session session){
        ...
        try{
    		...
    		for (Iterator iter = vector.iterator(); iter.hasNext();) {
    			...
    			sheet.addCell(new Label(x++, y, resultAndProductivity.get().getTypename()));
    			sheet.addCell(new Label(x++, y, resultAndProductivity.get().getModelcode()));
    			sheet.addCell(new Label(x++, y, resultAndProductivity.get().getShimuke()));
    			sheet.addCell(new Label(x++, y, resultAndProductivity.get().getName()));
    			sheet.addCell(new Number(x++, y, resultAndProductivity.get()));
    			sheet.addCell(new Number(x++, y, resultAndProductivity.get()));
