...
public class XlsExportOfBaseAction{
	public XlsExportOfBaseAction(Vector vector,OutputStream outputStream,Session session){
        ...
        try{
    		...
    		for (Iterator iter = vector.iterator(); iter.hasNext();) {
    			...
    			sheet.addCell(new Label(x++, y, base.get().getTypename()));
    			sheet.addCell(new Label(x++, y, base.get().getModelcode()));
    			sheet.addCell(new Label(x++, y, base.get().getShimuke()));
    			sheet.addCell(new Label(x++, y, base.get().getName()));
    			sheet.addCell(new Number(x++, y, base.get()));
    			sheet.addCell(new Number(x++, y, base.get()));
