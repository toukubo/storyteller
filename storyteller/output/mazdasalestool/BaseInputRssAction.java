...
public class BaseInputRssAction extends Action{
	public ActionForward execute(
		...
		while(enum.hasMoreElements()){
		  ...
		  while(items.hasMoreElements()){
                  	RssChannelItem item = (RssChannelItem) items.nextElement();	     		                Base base = new BaseImpl();
			base.setContent(item.getItemDescription());
			base.setTitle(itemIf.getItemTitle());
