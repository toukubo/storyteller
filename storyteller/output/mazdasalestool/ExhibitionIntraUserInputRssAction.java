...
public class ExhibitionIntraUserInputRssAction extends Action{
	public ActionForward execute(
		...
		while(enum.hasMoreElements()){
		  ...
		  while(items.hasMoreElements()){
                  	RssChannelItem item = (RssChannelItem) items.nextElement();	     		                ExhibitionIntraUser exhibitionIntraUser = new ExhibitionIntraUserImpl();
			exhibitionIntraUser.setContent(item.getItemDescription());
			exhibitionIntraUser.setTitle(itemIf.getItemTitle());
