...
public class PoliceRSSExportAction extends Action{
...
//	    		##secoundclass## ##secoundobj## = police.get##secoundclass##();
...
//	    			criteria.add(Restrictions.eq("##secoundobj##", ##secoundobj##));
	    			...
	    			ChannelIF newChannel = builder.createChannel("Polices");
	    			...
	    			newChannel.setDescription("Polices");
					...
					//item.setDate(new Date());
	    				...
	    				item.setTitle(police.getName());
	    				item.setLink(new URL("http://"+req.getServerName()+req.getRequestURI());
	    				item.setDescription(police.getName());
	    			...
	    			PrintWriter printWriter = new PrintWriter(new File(this.getServlet().getServletContext().getRealPath("PoliceRssExport.xml")),"utf-8");
