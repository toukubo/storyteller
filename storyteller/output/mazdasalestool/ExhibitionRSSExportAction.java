...
public class ExhibitionRSSExportAction extends Action{
...
//	    		##secoundclass## ##secoundobj## = exhibition.get##secoundclass##();
...
//	    			criteria.add(Restrictions.eq("##secoundobj##", ##secoundobj##));
	    			...
	    			ChannelIF newChannel = builder.createChannel("Exhibitions");
	    			...
	    			newChannel.setDescription("Exhibitions");
					...
					//item.setDate(new Date());
	    				...
	    				item.setTitle(exhibition.getName());
	    				item.setLink(new URL("http://"+req.getServerName()+req.getRequestURI());
	    				item.setDescription(exhibition.getName());
	    			...
	    			PrintWriter printWriter = new PrintWriter(new File(this.getServlet().getServletContext().getRealPath("ExhibitionRssExport.xml")),"utf-8");
