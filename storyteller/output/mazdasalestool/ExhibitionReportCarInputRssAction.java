...
public class ExhibitionReportCarInputRssAction extends Action{
	public ActionForward execute(
		...
		while(enum.hasMoreElements()){
		  ...
		  while(items.hasMoreElements()){
                  	RssChannelItem item = (RssChannelItem) items.nextElement();	     		                ExhibitionReportCar exhibitionReportCar = new ExhibitionReportCarImpl();
			exhibitionReportCar.setContent(item.getItemDescription());
			exhibitionReportCar.setTitle(itemIf.getItemTitle());
