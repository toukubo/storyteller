...
public class ExhibitionReportCarRSSExportAction extends Action{
...
//	    		##secoundclass## ##secoundobj## = exhibitionReportCar.get##secoundclass##();
...
//	    			criteria.add(Restrictions.eq("##secoundobj##", ##secoundobj##));
	    			...
	    			ChannelIF newChannel = builder.createChannel("ExhibitionReportCars");
	    			...
	    			newChannel.setDescription("ExhibitionReportCars");
					...
					//item.setDate(new Date());
	    				...
	    				item.setTitle(exhibitionReportCar.getName());
	    				item.setLink(new URL("http://"+req.getServerName()+req.getRequestURI());
	    				item.setDescription(exhibitionReportCar.getName());
	    			...
	    			PrintWriter printWriter = new PrintWriter(new File(this.getServlet().getServletContext().getRealPath("ExhibitionReportCarRssExport.xml")),"utf-8");
