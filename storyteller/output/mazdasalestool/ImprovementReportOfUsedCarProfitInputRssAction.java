...
public class ImprovementReportOfUsedCarProfitInputRssAction extends Action{
	public ActionForward execute(
		...
		while(enum.hasMoreElements()){
		  ...
		  while(items.hasMoreElements()){
                  	RssChannelItem item = (RssChannelItem) items.nextElement();	     		                ImprovementReportOfUsedCarProfit improvementReportOfUsedCarProfit = new ImprovementReportOfUsedCarProfitImpl();
			improvementReportOfUsedCarProfit.setContent(item.getItemDescription());
			improvementReportOfUsedCarProfit.setTitle(itemIf.getItemTitle());
