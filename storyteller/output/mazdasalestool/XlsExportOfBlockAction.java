...
public class XlsExportOfBlockAction{
	public XlsExportOfBlockAction(Vector vector,OutputStream outputStream,Session session){
        ...
        try{
    		...
    		for (Iterator iter = vector.iterator(); iter.hasNext();) {
    			...
    			sheet.addCell(new Label(x++, y, block.get().getTypename()));
    			sheet.addCell(new Label(x++, y, block.get().getModelcode()));
    			sheet.addCell(new Label(x++, y, block.get().getShimuke()));
    			sheet.addCell(new Label(x++, y, block.get().getName()));
    			sheet.addCell(new Number(x++, y, block.get()));
    			sheet.addCell(new Number(x++, y, block.get()));
