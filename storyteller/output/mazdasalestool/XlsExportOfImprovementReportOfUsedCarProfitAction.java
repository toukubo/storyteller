...
public class XlsExportOfImprovementReportOfUsedCarProfitAction{
	public XlsExportOfImprovementReportOfUsedCarProfitAction(Vector vector,OutputStream outputStream,Session session){
        ...
        try{
    		...
    		for (Iterator iter = vector.iterator(); iter.hasNext();) {
    			...
    			sheet.addCell(new Label(x++, y, improvementReportOfUsedCarProfit.get().getTypename()));
    			sheet.addCell(new Label(x++, y, improvementReportOfUsedCarProfit.get().getModelcode()));
    			sheet.addCell(new Label(x++, y, improvementReportOfUsedCarProfit.get().getShimuke()));
    			sheet.addCell(new Label(x++, y, improvementReportOfUsedCarProfit.get().getName()));
    			sheet.addCell(new Number(x++, y, improvementReportOfUsedCarProfit.get()));
    			sheet.addCell(new Number(x++, y, improvementReportOfUsedCarProfit.get()));
