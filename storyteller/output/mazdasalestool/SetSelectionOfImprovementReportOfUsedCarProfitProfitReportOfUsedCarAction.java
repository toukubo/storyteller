...
public class SetSelectionOfImprovementReportOfUsedCarProfitProfitReportOfUsedCarAction extends Action{
	public ActionForward execute(
		...
		for (int I = 0; I < req.getParameterValues("id").length; i++) {
			Criteria criteria2 = session.createCriteria(ImprovementReportOfUsedCarProfit.class);
			...
			improvementReportOfUsedCarProfit.setprofitReportOfUsedCar(true);
			session.save(improvementReportOfUsedCarProfit);
		}
		transaction.commit();
		session.flush();
