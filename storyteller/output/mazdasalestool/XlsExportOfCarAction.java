...
public class XlsExportOfCarAction{
	public XlsExportOfCarAction(Vector vector,OutputStream outputStream,Session session){
        ...
        try{
    		...
    		for (Iterator iter = vector.iterator(); iter.hasNext();) {
    			...
    			sheet.addCell(new Label(x++, y, car.get().getTypename()));
    			sheet.addCell(new Label(x++, y, car.get().getModelcode()));
    			sheet.addCell(new Label(x++, y, car.get().getShimuke()));
    			sheet.addCell(new Label(x++, y, car.get().getName()));
    			sheet.addCell(new Number(x++, y, car.get()));
    			sheet.addCell(new Number(x++, y, car.get()));
