...
public class ResultAndProductivityRSSExportAction extends Action{
...
//	    		##secoundclass## ##secoundobj## = resultAndProductivity.get##secoundclass##();
...
//	    			criteria.add(Restrictions.eq("##secoundobj##", ##secoundobj##));
	    			...
	    			ChannelIF newChannel = builder.createChannel("ResultAndProductivitys");
	    			...
	    			newChannel.setDescription("ResultAndProductivitys");
					...
					//item.setDate(new Date());
	    				...
	    				item.setTitle(resultAndProductivity.getName());
	    				item.setLink(new URL("http://"+req.getServerName()+req.getRequestURI());
	    				item.setDescription(resultAndProductivity.getName());
	    			...
	    			PrintWriter printWriter = new PrintWriter(new File(this.getServlet().getServletContext().getRealPath("ResultAndProductivityRssExport.xml")),"utf-8");
