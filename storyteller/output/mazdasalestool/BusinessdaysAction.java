...
public class BusinessdaysAction extends Action{
	public ActionForward execute(
		...
		for (Iterator iter = criteria.list().iterator(); iter.hasNext();) {
			Businessday businessday = (Businessday) iter.next();
			vector.add(businessday);
		}
		Businessday businessday = new BusinessdayImpl();
		BusinessdayForm businessdayform = new BusinessdayForm();
		criteria = session.createCriteria(Businessday.class);
		...
		req.setAttribute("businessdays",vector);
