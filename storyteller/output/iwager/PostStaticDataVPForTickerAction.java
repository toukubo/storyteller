...
public class PostStaticDataVPForTickerAction extends Action{
	public ActionForward execute(
		...
		if(staticDataform.getId() == null || staticDataform.getId().intValue() == 0){
			...
			staticData = (StaticData) criteria.uniqueResult();
                		...
                		staticData.setSmtphost(staticDataform.getSmtphost());
		staticData.setSmtpacocunt(staticDataform.getSmtpacocunt());
		staticData.setSmtppassword(staticDataform.getSmtppassword());
		...
		staticData.setHumanalecostrate(staticDataform.getHumanalecostrate());
		staticData.setCostpercentage(staticDataform.getCostpercentage());
		staticData.setJackpot(staticDataform.getJackpot());
		staticData.setTicker(staticDataform.getTicker());
