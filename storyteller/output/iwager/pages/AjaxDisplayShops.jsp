	...
	<meta http-equiv="Content-Type" content="text/html; charset=UTF-8"/>
		...
		<script src="rico.js" type="text/javascript"></script>
         <script type="text/javascript">
             function ajax(num) {
                 var ajaxRequest = new AjaxRequest('PostShopVP.do'); //Create AjaxRequest object
				 ajaxRequest.addFormElementsById(num + '_id');
				 ajaxRequest.addFormElementsById(num + '_ajax');
		 		 ajaxRequest.addFormElementsById(num + '_gameTables');
		 		 ajaxRequest.addFormElementsById(num + '_jackpot');
...
<div id="message"></div>
                    <display:table name="${shops}" id="row" requestURI="AjaxDisplayShops.do"
...
<nobr><input size="8" type="text" name="jackpot" id="${row.id}_jackpot" value="${row.jackpot}" /></nobr>
</display:column>
