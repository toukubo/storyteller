...
<span class="title">一覧</span>
                    <display:table name="${dealers}" id="row" requestURI="Dealers.do"
                            requestURIcontext="false"
                            export="false" pagesize="30" sort="list">
                        <display:column media="html" sortable="false">
                        <a href="Dealers.do?id=${row.id}">編集</a>
                        <a href="DeleteDealer.do?id=${row.id}">削除</a>
                        </display:column>
...
<a href="Dealers.do?d-16544-e=1&6578706f7274=1&displayexport">
CVS
</a>
<a href="Dealers.do?d-16544-e=2&6578706f7274=1&displayexport">
XLS
</a>
<a href="Dealers.do?d-16544-e=3&6578706f7274=1&displayexport">
XML
</a>
<a href="Dealers.do?d-16544-e=4&6578706f7274=1&displayexport">
PDF
</a>
...
<span id="subform">
		...
		<form method="POST" action="PostDealerVP.do">
