	...
	<meta http-equiv="Content-Type" content="text/html; charset=UTF-8"/>
		...
		<script src="rico.js" type="text/javascript"></script>
         <script type="text/javascript">
             function ajax(num) {
                 var ajaxRequest = new AjaxRequest('PostDealerVP.do'); //Create AjaxRequest object
				 ...
				 ajaxRequest.addFormElementsById(num + '_ajax');
		 		 ...
		 		 ajaxRequest.addFormElementsById(num + '_plays');
...
<div id="message"></div>
                    <display:table name="${dealers}" id="row" requestURI="AjaxDisplayDealers.do"
