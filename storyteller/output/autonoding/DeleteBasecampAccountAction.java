...
public class DeleteBasecampAccountAction extends Action{
	public ActionForward execute(
		...
		BasecampAccount basecampAccount = (BasecampAccount) criteria.uniqueResult();
		session.delete(basecampAccount);
		transaction.commit();
		session.flush();
