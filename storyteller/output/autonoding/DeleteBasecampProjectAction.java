...
public class DeleteBasecampProjectAction extends Action{
	public ActionForward execute(
		...
		BasecampProject basecampProject = (BasecampProject) criteria.uniqueResult();
		session.delete(basecampProject);
		transaction.commit();
		session.flush();
