...
<div>
        sheet.addCell(new Label(x++,y,context.getName()));
                      ...
                      <select name="hasenoughnodes" > <option value=""></option> <option value="true"></option>   <option value="false"></option>   </select>  &nbsp;
                   ...
                   サイト
                    ...
                    <display:table name="${contexts}" id="row" requestURI="Contexts.do"
                            requestURIcontext="false"
                            export="false" pagesize="30" sort="list">
                        <display:column media="html" sortable="false">
                        <a href="ShowContext.do?id=${row.id}">Show</a> | 
                        <a href="PostContextDetail.do?id=${row.id}"><img src="icons/table_edit.png"></a>
                        <a href="DeleteContext.do?id=${row.id}">削除</a>
                        </display:column>
...
${row.name}
 ...
 <display:column media="html" sortable="true" title="hasenoughnodes">
<nobr>
${row.hasenoughnodes}
</nobr>
</display:column>
