...
public class DeleteLoginLogsDailyAction extends Action{
	public ActionForward execute(
		...
		LoginLog loginLog = (LoginLog) criteria.uniqueResult();
		...
		session.flush();
				...
				new HTTPGetRedirection(req, res, "LoginLogs.do",null);
		return null;
