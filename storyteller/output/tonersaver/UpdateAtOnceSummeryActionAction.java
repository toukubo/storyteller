...
public class UpdateAtOnceSummeryActionAction extends Action{
	...
	public static void main(String[] args) {
		try {
				...
				UpdateAtOnceSummeryActionAction action = new UpdateAtOnceSummeryActionAction();
				Criteria criteria = session.createCriteria(Summery.class);
				criteria.add(Restrictions.idEq(new Integer(1)));
				Summery summery = (Summery) criteria.uniqueResult();
				action.execute(summery, session);
				session.close();
