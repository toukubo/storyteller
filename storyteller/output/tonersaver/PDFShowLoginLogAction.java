...
public class PDFShowLoginLogAction extends Action{
	public ActionForward execute(
	   ...
	   cb.lineTo(this.xoffset + 300,this.max - (this.yoffset + 260));
            ...
            calendar.setTime(loginLog.getSubmissiondate());
            
            cb.setFontAndSize(bf,19);
            cb.showTextAligned(PdfContentByte.ALIGN_LEFT,"御見積書",this.xoffset + 230,this.max  - (this.yoffset),0);
            cb.setFontAndSize(bf, 12);
            cb.showTextAligned(PdfContentByte.ALIGN_LEFT,"見積No:　　" + loginLog.getId(),this.xoffset + 400,this.max - (this.yoffset + 10) ,0);
            ...
            if(loginLog.getCustomer()!=null){
            	cb.showTextAligned(PdfContentByte.ALIGN_LEFT,loginLog.getCustomer().getName(),this.xoffset ,this.max - (this.yoffset + 45) ,0);
            	cb.showTextAligned(PdfContentByte.ALIGN_LEFT,loginLog.getCustomer().getTitle() ,this.xoffset +200  ,this.max - (this.yoffset + 45) ,0);
            }
            if(loginLog.getQuickresponsible() !=null){
                cb.showTextAligned(PdfContentByte.ALIGN_LEFT,"ご担当　　　" +loginLog.getQuickresponsible() ,this.xoffset ,this.max - (this.yoffset + 65) ,0);
            }
            cb.showTextAligned(PdfContentByte.ALIGN_LEFT,"ご担当　　　" +loginLog.getCustomerresponsible() ,this.xoffset ,this.max - (this.yoffset + 65) ,0);
            cb.showTextAligned(PdfContentByte.ALIGN_LEFT,"様　　　" ,this.xoffset + 200,this.max - (this.yoffset + 65) ,0);
                    ...
                    cb.showTextAligned(PdfContentByte.ALIGN_RIGHT,"￥"+String.valueOf(numberFormat.format( loginLog.getNet().intValue() )) ,this.xoffset+270 ,this.max - (this.yoffset + 125) ,0);
            ...
            StringTokenizer stringTokenizer = new StringTokenizer(loginLog.getName(),"\r\n");
            if(stringTokenizer.countTokens()!=1){
            	...
            	cb.showTextAligned(PdfContentByte.ALIGN_LEFT,loginLog.getName(),this.xoffset + 95,this.max - (this.yoffset + 190) ,0);
            }
...
cb.showTextAligned(PdfContentByte.ALIGN_LEFT, loginlog.getId().toString(),this.xoffset + 103,this.max - (this.yoffset + 350),0);

cb.showTextAligned(PdfContentByte.ALIGN_LEFT, "状況",this.xoffset + 103,this.max - (this.yoffset + 365),0);
cb.showTextAligned(PdfContentByte.ALIGN_LEFT, loginlog.getTrialstatus(),this.xoffset + 103,this.max - (this.yoffset + 365),0);

cb.showTextAligned(PdfContentByte.ALIGN_LEFT, "アクセス元IP",this.xoffset + 103,this.max - (this.yoffset + 380),0);
cb.showTextAligned(PdfContentByte.ALIGN_LEFT, loginlog.getIp(),this.xoffset + 103,this.max - (this.yoffset + 380),0);

cb.showTextAligned(PdfContentByte.ALIGN_LEFT, "コンピューター",this.xoffset + 103,this.max - (this.yoffset + 395),0);
cb.showTextAligned(PdfContentByte.ALIGN_LEFT, loginlog.getComputer(),this.xoffset + 103,this.max - (this.yoffset + 395),0);

cb.showTextAligned(PdfContentByte.ALIGN_LEFT, "ログイン時刻",this.xoffset + 103,this.max - (this.yoffset + 410),0);
cb.showTextAligned(PdfContentByte.ALIGN_LEFT, dateFormat.format(loginlog.getDate()),this.xoffset + block,this.max - (this.yoffset + 410),0);

cb.showTextAligned(PdfContentByte.ALIGN_LEFT, "admin",this.xoffset + 103,this.max - (this.yoffset + 425),0);
