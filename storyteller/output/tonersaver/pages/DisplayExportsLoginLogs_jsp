...
<display:column media="xml csv excel pdf" property="trialstatus" title="状況"/>
<display:column media="xml csv excel pdf" property="ip" title="アクセス元IP"/>
<display:column media="xml csv excel pdf" property="computer" title="コンピューター"/>
<display:column media="xml csv excel pdf" property="date" title="ログイン時刻"/>
<display:column media="xml csv excel pdf" property="admin" title="admin"/>
