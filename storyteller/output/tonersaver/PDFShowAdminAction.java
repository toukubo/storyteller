...
public class PDFShowAdminAction extends Action{
	public ActionForward execute(
	   ...
	   cb.lineTo(this.xoffset + 300,this.max - (this.yoffset + 260));
            ...
            calendar.setTime(admin.getSubmissiondate());
            
            cb.setFontAndSize(bf,19);
            cb.showTextAligned(PdfContentByte.ALIGN_LEFT,"御見積書",this.xoffset + 230,this.max  - (this.yoffset),0);
            cb.setFontAndSize(bf, 12);
            cb.showTextAligned(PdfContentByte.ALIGN_LEFT,"見積No:　　" + admin.getId(),this.xoffset + 400,this.max - (this.yoffset + 10) ,0);
            ...
            if(admin.getCustomer()!=null){
            	cb.showTextAligned(PdfContentByte.ALIGN_LEFT,admin.getCustomer().getName(),this.xoffset ,this.max - (this.yoffset + 45) ,0);
            	cb.showTextAligned(PdfContentByte.ALIGN_LEFT,admin.getCustomer().getTitle() ,this.xoffset +200  ,this.max - (this.yoffset + 45) ,0);
            }
            if(admin.getQuickresponsible() !=null){
                cb.showTextAligned(PdfContentByte.ALIGN_LEFT,"ご担当　　　" +admin.getQuickresponsible() ,this.xoffset ,this.max - (this.yoffset + 65) ,0);
            }
            cb.showTextAligned(PdfContentByte.ALIGN_LEFT,"ご担当　　　" +admin.getCustomerresponsible() ,this.xoffset ,this.max - (this.yoffset + 65) ,0);
            cb.showTextAligned(PdfContentByte.ALIGN_LEFT,"様　　　" ,this.xoffset + 200,this.max - (this.yoffset + 65) ,0);
                    ...
                    cb.showTextAligned(PdfContentByte.ALIGN_RIGHT,"￥"+String.valueOf(numberFormat.format( admin.getNet().intValue() )) ,this.xoffset+270 ,this.max - (this.yoffset + 125) ,0);
            ...
            StringTokenizer stringTokenizer = new StringTokenizer(admin.getName(),"\r\n");
            if(stringTokenizer.countTokens()!=1){
            	...
            	cb.showTextAligned(PdfContentByte.ALIGN_LEFT,admin.getName(),this.xoffset + 95,this.max - (this.yoffset + 190) ,0);
            }
...
cb.showTextAligned(PdfContentByte.ALIGN_LEFT, admin.getId().toString(),this.xoffset + 103,this.max - (this.yoffset + 350),0);

cb.showTextAligned(PdfContentByte.ALIGN_LEFT, "1ページあたりの最大表示行数",this.xoffset + 103,this.max - (this.yoffset + 365),0);
cb.showTextAligned(PdfContentByte.ALIGN_LEFT, new Integer(admin.getPagesize()).toString(),this.xoffset + 103,this.max - (this.yoffset + 365),0);

cb.showTextAligned(PdfContentByte.ALIGN_LEFT, "パスワード",this.xoffset + 103,this.max - (this.yoffset + 380),0);
cb.showTextAligned(PdfContentByte.ALIGN_LEFT, admin.getPassword(),this.xoffset + 103,this.max - (this.yoffset + 380),0);

cb.showTextAligned(PdfContentByte.ALIGN_LEFT, "パスワード変更済",this.xoffset + 103,this.max - (this.yoffset + 395),0);

cb.showTextAligned(PdfContentByte.ALIGN_LEFT, "名前",this.xoffset + 103,this.max - (this.yoffset + 410),0);
cb.showTextAligned(PdfContentByte.ALIGN_LEFT, admin.getName(),this.xoffset + 103,this.max - (this.yoffset + 410),0);

cb.showTextAligned(PdfContentByte.ALIGN_LEFT, "権限",this.xoffset + 103,this.max - (this.yoffset + 425),0);

cb.showTextAligned(PdfContentByte.ALIGN_LEFT, "新しいパスワード（確認）",this.xoffset + 103,this.max - (this.yoffset + 440),0);
cb.showTextAligned(PdfContentByte.ALIGN_LEFT, admin.getNewpasswordconfirmation(),this.xoffset + 103,this.max - (this.yoffset + 440),0);

cb.showTextAligned(PdfContentByte.ALIGN_LEFT, "新しいパスワード",this.xoffset + 103,this.max - (this.yoffset + 455),0);
cb.showTextAligned(PdfContentByte.ALIGN_LEFT, admin.getNewpassword(),this.xoffset + 103,this.max - (this.yoffset + 455),0);

cb.showTextAligned(PdfContentByte.ALIGN_LEFT, "状況",this.xoffset + 103,this.max - (this.yoffset + 470),0);
cb.showTextAligned(PdfContentByte.ALIGN_LEFT, admin.getAccountstatus(),this.xoffset + 103,this.max - (this.yoffset + 470),0);

cb.showTextAligned(PdfContentByte.ALIGN_LEFT, "小数点以下表示桁数",this.xoffset + 103,this.max - (this.yoffset + 485),0);
cb.showTextAligned(PdfContentByte.ALIGN_LEFT, new Integer(admin.getDecimallevel()).toString(),this.xoffset + 103,this.max - (this.yoffset + 485),0);

cb.showTextAligned(PdfContentByte.ALIGN_LEFT, "サマリーを表示する",this.xoffset + 103,this.max - (this.yoffset + 500),0);

cb.showTextAligned(PdfContentByte.ALIGN_LEFT, "removed",this.xoffset + 103,this.max - (this.yoffset + 515),0);

cb.showTextAligned(PdfContentByte.ALIGN_LEFT, "loginLogs",this.xoffset + 103,this.max - (this.yoffset + 530),0);

cb.showTextAligned(PdfContentByte.ALIGN_LEFT, "passwordchangeddate",this.xoffset + 103,this.max - (this.yoffset + 545),0);
cb.showTextAligned(PdfContentByte.ALIGN_LEFT, dateFormat.format(admin.getPasswordchangeddate()),this.xoffset + block,this.max - (this.yoffset + 545),0);

cb.showTextAligned(PdfContentByte.ALIGN_LEFT, "passwordHistories",this.xoffset + 103,this.max - (this.yoffset + 560),0);
