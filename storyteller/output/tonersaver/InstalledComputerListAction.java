...
public class InstalledComputerListAction extends Action{
...
//        }
		...
		req.setAttribute("installedComputers",criteria.list());
...
/*
		...
		<a href="InstalledComputerList.do?currentpage=${page}">
		${page}
		</a>
		</c:forEach>
