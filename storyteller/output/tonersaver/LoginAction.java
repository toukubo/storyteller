...
public class LoginAction extends Action{
	public ActionForward execute(
		...
		criteria.add(Restrictions.eq("account",adminForm.getAccount()));
		criteria.add(Restrictions.eq("password",adminForm.getPassword()));
		...
		if(criteria.uniqueResult() !=null){
			...
			*/
			...
			Cookie cookie = new Cookie("tonersaver",admin.getMail());
			cookie.setValue(admin.getMail());
