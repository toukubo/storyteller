...
public class XlsExportOfBrandAction{
	public XlsExportOfBrandAction(Vector vector,OutputStream outputStream,Session session){
        ...
        try{
    		...
    		for (Iterator iter = vector.iterator(); iter.hasNext();) {
    			...
    			sheet.addCell(new Label(x++, y, brand.get().getTypename()));
    			sheet.addCell(new Label(x++, y, brand.get().getModelcode()));
    			sheet.addCell(new Label(x++, y, brand.get().getShimuke()));
    			sheet.addCell(new Label(x++, y, brand.get().getName()));
    			sheet.addCell(new Number(x++, y, brand.get()));
    			sheet.addCell(new Number(x++, y, brand.get()));
