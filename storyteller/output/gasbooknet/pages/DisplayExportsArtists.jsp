...
<display:column media="xml csv excel pdf" property="poplularity" title="poplularity"/>
<display:column media="xml csv excel pdf" property="date" title="日付"/>
<display:column media="xml csv excel pdf" property="responsible" title="responsible"/>
