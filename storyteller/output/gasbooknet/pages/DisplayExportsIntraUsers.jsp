...
<display:column media="xml csv excel pdf" property="flag" title="フラグ"/>
...
<display:column media="xml csv excel pdf" property="phonenum" title="電話番号"/>
...
<display:column media="xml csv excel pdf" property="products" title="products"/>
<display:column media="xml csv excel pdf" property="works" title="作品"/>
<display:column media="xml csv excel pdf" property="news" title="ニュース"/>
<display:column media="xml csv excel pdf" property="artists" title="アーティスト"/>
<display:column media="xml csv excel pdf" property="rememberme" title="rememberme"/>
