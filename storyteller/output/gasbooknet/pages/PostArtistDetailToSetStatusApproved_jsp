...
disciplinestring<br />
<html:text name="form" property="disciplinestring" /><br />

                                descipline<br />
                                <c:choose>
                                    <c:when test="${empty Desciplines}">
                                         <select name="descipline" disabled="disabled"/>
                                    </c:when>
                                    <c:otherwise>
                                        <select name="descipline" ><option value=""></option>
                                            <c:forEach var="valueLabel" items="${Desciplines}">
                                                <c:choose>
                                                    <c:when test="${valueLabel.id eq model.descipline.id}">
                                                        <option value="${valueLabel.id}" selected="selected">${valueLabel.name}</option>
                                                    </c:when>
                                                    <c:otherwise>
                                                        <option value="${valueLabel.id}">${valueLabel.name}</option>
                                ...
                                <c:choose>
                                    <c:when test="${empty Disciplines}">
                                         <select name="discipline" disabled="disabled"/>
                                    </c:when>
                                    <c:otherwise>
                                        <select name="discipline" ><option value=""></option>
                                            <c:forEach var="valueLabel" items="${Disciplines}">
                                                <c:choose>
                                                    <c:when test="${valueLabel.id eq model.discipline.id}">
                                                        <option value="${valueLabel.id}" selected="selected">${valueLabel.name}</option>
                                                    </c:when>
                                                    <c:otherwise>
                                                        <option value="${valueLabel.id}">${valueLabel.name}</option>
...
branchaddress<br />
<html:text name="form" property="branchaddress" /><br />

ziperror<br />
<html:text name="form" property="ziperror" /><br />
