...
<br/>
ニュース
				<display:table name="genre.news" id="row" requestURI=".do" pagesize="0" 
 requestURIcontext="false" sort="list" export="false" >
                        </display:table>
<br/>
アーティスト
<div>
<logic:iterate id="artist" name="genre" property="artists">名前
${artist.name}
<br/>
日付
...
</div>				<display:table name="genre.artists" id="row" requestURI=".do" pagesize="0" 
 requestURIcontext="false" sort="list" export="false" >
 <display:column media="html" sortable="true" title="名前">
<nobr>
${row.name}
