...
artists
<div>
<logic:iterate id="artist" name="discipline" property="artists">名前
${artist.name}
<br/>
日付
date<st:date date="${artist.id
${discipline.id}
<br/>
artists
<div>
...
<br/>
誕生日
birthdate<st:date date="${artist.id
${discipline.id}
<br/>
artists
<div>
...
<br/>
ライセンス契約終了年月
expiredate<st:date date="${work.id
${discipline.id}
<br/>
artists
<div>
...
</div>				<display:table name="discipline.artists" id="row" requestURI=".do" pagesize="0" 
 requestURIcontext="false" sort="list" export="false" >
 <display:column media="html" sortable="true" title="名前">
<nobr>
${row.name}
