...
<br/>
日付
<bean:write name="artist" property="date" format="yyyy/MM/dd" />
<br/>
アドレス
${artist.address}
<br/>
...
</div>				<display:table name="artist.contracts" id="row" requestURI="ForIntraUser.do" pagesize="0" 
...
<br/>
誕生日
<bean:write name="artist" property="birthdate" format="yyyy/MM/dd" />
<br/>
職種
...
</div>				<display:table name="artist.works" id="row" requestURI="ForIntraUser.do" pagesize="0" 
 requestURIcontext="false" sort="list" export="false" >
...
</div>				<display:table name="artist.eventAttendances" id="row" requestURI="ForIntraUser.do" pagesize="0" 
 requestURIcontext="false" sort="list" export="false" >
 <display:column media="html" sortable="true" title="ID" property="id" >
...
</div>				<display:table name="artist.awordWInners" id="row" requestURI="ForIntraUser.do" pagesize="0" 
 requestURIcontext="false" sort="list" export="false" >
 <display:column media="html" sortable="true" title="ID" property="id" >
...
<br/>
ニュース
				<display:table name="artist.news" id="row" requestURI="ForIntraUser.do" pagesize="0" 
 requestURIcontext="false" sort="list" export="false" >
                        </display:table>
<br/>
ジャンル
