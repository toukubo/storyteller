...
public class EventRSSExportAction extends Action{
...
//	    		##secoundclass## ##secoundobj## = event.get##secoundclass##();
...
//	    			criteria.add(Restrictions.eq("##secoundobj##", ##secoundobj##));
	    			...
	    			ChannelIF newChannel = builder.createChannel("Events");
	    			...
	    			newChannel.setDescription("Events");
					...
					//item.setDate(new Date());
	    				...
	    				item.setDescription(event.getName());
	    			...
	    			PrintWriter printWriter = new PrintWriter(new File(this.getServlet().getServletContext().getRealPath("EventRssExport.xml")),"utf-8");
