...
public class PostArtistDetailForSettingZiperrorEmptyAction extends Action{
...
Criteria criteriaArtistXlsFile= session.createCriteria(ArtistXlsFile.class);
			req.setAttribute("ArtistXlsFiles", criteriaArtistXlsFile.list());

Criteria criteriaDescipline= session.createCriteria(Descipline.class);
			req.setAttribute("Desciplines", criteriaDescipline.list());

Criteria criteriaDiscipline= session.createCriteria(Discipline.class);
			req.setAttribute("Disciplines", criteriaDiscipline.list());
