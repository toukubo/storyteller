...
public class UpdateWorkAttachmentForDummyEntryAction extends Action{
	...
	public static void main(String[] args) {
		try {
				...
				UpdateWorkAttachmentForDummyEntryAction action = new UpdateWorkAttachmentForDummyEntryAction();
				Criteria criteria = session.createCriteria(WorkAttachment.class);
