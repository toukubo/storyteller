...
public class AttachmentFormFileUploadAddingToEventAction extends Action{
...
//			new HTTPGetRedirection(req, res, "##secoundmodelclass##Detail.do", attachmentform.getEvent().toString());
			req.setAttribute("id",attachmentform.getEvent());
			return mapping.findForward("error");
		}
		
		Integer EventInt = Integer.valueOf(req.getParameter("event"));
...
//		attachment.setEvent(event);
		...
		new HTTPGetRedirection(req, res, "PostEventDetail.do", EventInt.toString());
		return null;
