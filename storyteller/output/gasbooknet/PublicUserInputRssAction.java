...
public class PublicUserInputRssAction extends Action{
	public ActionForward execute(
		...
		while(enum.hasMoreElements()){
		  ...
		  while(items.hasMoreElements()){
                  	RssChannelItem item = (RssChannelItem) items.nextElement();	     		                PublicUser publicUser = new PublicUserImpl();
			publicUser.setContent(item.getItemDescription());
			publicUser.setTitle(itemIf.getItemTitle());
