...
public class XlsExportOfZipFtpServerAction{
	public XlsExportOfZipFtpServerAction(Vector vector,OutputStream outputStream,Session session){
        ...
        try{
    		...
    		for (Iterator iter = vector.iterator(); iter.hasNext();) {
    			...
    			sheet.addCell(new Label(x++, y, zipFtpServer.get().getTypename()));
    			sheet.addCell(new Label(x++, y, zipFtpServer.get().getModelcode()));
    			sheet.addCell(new Label(x++, y, zipFtpServer.get().getShimuke()));
    			sheet.addCell(new Label(x++, y, zipFtpServer.get().getName()));
    			sheet.addCell(new Number(x++, y, zipFtpServer.get()));
    			sheet.addCell(new Number(x++, y, zipFtpServer.get()));
