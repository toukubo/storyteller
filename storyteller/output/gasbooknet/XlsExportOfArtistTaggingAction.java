...
public class XlsExportOfArtistTaggingAction{
	public XlsExportOfArtistTaggingAction(Vector vector,OutputStream outputStream,Session session){
        ...
        try{
    		...
    		for (Iterator iter = vector.iterator(); iter.hasNext();) {
    			...
    			sheet.addCell(new Label(x++, y, artistTagging.get().getTypename()));
    			sheet.addCell(new Label(x++, y, artistTagging.get().getModelcode()));
    			sheet.addCell(new Label(x++, y, artistTagging.get().getShimuke()));
    			sheet.addCell(new Label(x++, y, artistTagging.get().getName()));
    			sheet.addCell(new Number(x++, y, artistTagging.get()));
    			sheet.addCell(new Number(x++, y, artistTagging.get()));
