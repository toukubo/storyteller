...
public class AccessLogInputRssAction extends Action{
	public ActionForward execute(
		...
		while(enum.hasMoreElements()){
		  ...
		  while(items.hasMoreElements()){
                  	RssChannelItem item = (RssChannelItem) items.nextElement();	     		                AccessLog accessLog = new AccessLogImpl();
			accessLog.setContent(item.getItemDescription());
			accessLog.setTitle(itemIf.getItemTitle());
