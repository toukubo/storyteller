...
public class AttachmentFormFileUploadAddingToBrandAction extends Action{
...
//			new HTTPGetRedirection(req, res, "##secoundmodelclass##Detail.do", attachmentform.getBrand().toString());
			req.setAttribute("id",attachmentform.getBrand());
			return mapping.findForward("error");
		}
		
		Integer BrandInt = Integer.valueOf(req.getParameter("brand"));
...
//		attachment.setNumber(Integer.parseInt(req.getParameter("setNumber")));
		...
		Brand brand = (Brand) criteria2
				.uniqueResult();
//		attachment.setBrand(brand);
		...
		new HTTPGetRedirection(req, res, "PostBrandDetail.do", BrandInt.toString());
		return null;
