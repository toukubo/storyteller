...
public class PostArtistVPForSettingZiperrorEmptyAction extends Action{
	public ActionForward execute(
		...
		Integer desciplineInt = artistform.getDescipline();
		artistform.setDescipline(null);
		Integer disciplineInt = artistform.getDiscipline();
		artistform.setDiscipline(null);
		...
		artist.setDisciplinestring(artistform.getDisciplinestring());
		artist.setBranchaddress(artistform.getBranchaddress());
		artist.setZiperror(artistform.getZiperror());
		...
		criteria2 = session.createCriteria(Descipline.class);
		criteria2.add(Restrictions.idEq(desciplineInt));
		Descipline descipline = (Descipline) criteria2.uniqueResult();
		artist.setDescipline(descipline);
		criteria2 = session.createCriteria(Discipline.class);
		criteria2.add(Restrictions.idEq(disciplineInt));
		Discipline discipline = (Discipline) criteria2.uniqueResult();
		artist.setDiscipline(discipline);
