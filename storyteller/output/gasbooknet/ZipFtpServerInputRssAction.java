...
public class ZipFtpServerInputRssAction extends Action{
	public ActionForward execute(
		...
		while(enum.hasMoreElements()){
		  ...
		  while(items.hasMoreElements()){
                  	RssChannelItem item = (RssChannelItem) items.nextElement();	     		                ZipFtpServer zipFtpServer = new ZipFtpServerImpl();
			zipFtpServer.setContent(item.getItemDescription());
			zipFtpServer.setTitle(itemIf.getItemTitle());
