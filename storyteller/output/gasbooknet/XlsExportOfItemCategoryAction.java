...
public class XlsExportOfItemCategoryAction{
	public XlsExportOfItemCategoryAction(Vector vector,OutputStream outputStream,Session session){
        ...
        try{
    		...
    		for (Iterator iter = vector.iterator(); iter.hasNext();) {
    			...
    			sheet.addCell(new Label(x++, y, itemCategory.get().getTypename()));
    			sheet.addCell(new Label(x++, y, itemCategory.get().getModelcode()));
    			sheet.addCell(new Label(x++, y, itemCategory.get().getShimuke()));
    			sheet.addCell(new Label(x++, y, itemCategory.get().getName()));
    			sheet.addCell(new Number(x++, y, itemCategory.get()));
    			sheet.addCell(new Number(x++, y, itemCategory.get()));
