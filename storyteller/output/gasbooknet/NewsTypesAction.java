...
public class NewsTypesAction extends Action{
	public ActionForward execute(
		...
		Criteria criteria2 = session.createCriteria(NewsType.class);

		if (req.getParameter("id") != null
				&& !req.getParameter("id").equals("")) {
			criteria2.add(Restrictions.idEq(Integer.valueOf(req
					.getParameter("id"))));
			newsType = (NewsType) criteria2.uniqueResult();
		...
		req.setAttribute("newsTypes",vector);
