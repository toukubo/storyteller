...
public class ArtistTaggingInputRssAction extends Action{
	public ActionForward execute(
		...
		while(enum.hasMoreElements()){
		  ...
		  while(items.hasMoreElements()){
                  	RssChannelItem item = (RssChannelItem) items.nextElement();	     		                ArtistTagging artistTagging = new ArtistTaggingImpl();
			artistTagging.setContent(item.getItemDescription());
			artistTagging.setTitle(itemIf.getItemTitle());
