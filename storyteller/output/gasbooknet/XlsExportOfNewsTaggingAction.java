...
public class XlsExportOfNewsTaggingAction{
	public XlsExportOfNewsTaggingAction(Vector vector,OutputStream outputStream,Session session){
        ...
        try{
    		...
    		for (Iterator iter = vector.iterator(); iter.hasNext();) {
    			...
    			sheet.addCell(new Label(x++, y, newsTagging.get().getTypename()));
    			sheet.addCell(new Label(x++, y, newsTagging.get().getModelcode()));
    			sheet.addCell(new Label(x++, y, newsTagging.get().getShimuke()));
    			sheet.addCell(new Label(x++, y, newsTagging.get().getName()));
    			sheet.addCell(new Number(x++, y, newsTagging.get()));
    			sheet.addCell(new Number(x++, y, newsTagging.get()));
