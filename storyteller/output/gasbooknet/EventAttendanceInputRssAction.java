...
public class EventAttendanceInputRssAction extends Action{
	public ActionForward execute(
		...
		while(enum.hasMoreElements()){
		  ...
		  while(items.hasMoreElements()){
                  	RssChannelItem item = (RssChannelItem) items.nextElement();	     		                EventAttendance eventAttendance = new EventAttendanceImpl();
			eventAttendance.setContent(item.getItemDescription());
			eventAttendance.setTitle(itemIf.getItemTitle());
