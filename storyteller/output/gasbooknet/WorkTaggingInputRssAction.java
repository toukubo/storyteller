...
public class WorkTaggingInputRssAction extends Action{
	public ActionForward execute(
		...
		while(enum.hasMoreElements()){
		  ...
		  while(items.hasMoreElements()){
                  	RssChannelItem item = (RssChannelItem) items.nextElement();	     		                WorkTagging workTagging = new WorkTaggingImpl();
			workTagging.setContent(item.getItemDescription());
			workTagging.setTitle(itemIf.getItemTitle());
