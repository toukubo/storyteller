...
public class NewsTaggingInputRssAction extends Action{
	public ActionForward execute(
		...
		while(enum.hasMoreElements()){
		  ...
		  while(items.hasMoreElements()){
                  	RssChannelItem item = (RssChannelItem) items.nextElement();	     		                NewsTagging newsTagging = new NewsTaggingImpl();
			newsTagging.setContent(item.getItemDescription());
			newsTagging.setTitle(itemIf.getItemTitle());
