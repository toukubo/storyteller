...
public class AttachmentFormFileUploadAddingToSpaceAction extends Action{
...
//			new HTTPGetRedirection(req, res, "##secoundmodelclass##Detail.do", attachmentform.getSpace().toString());
			req.setAttribute("id",attachmentform.getSpace());
			return mapping.findForward("error");
		}
		
		Integer SpaceInt = Integer.valueOf(req.getParameter("space"));
...
//		attachment.setSpace(space);
		...
		new HTTPGetRedirection(req, res, "PostSpaceDetail.do", SpaceInt.toString());
		return null;
