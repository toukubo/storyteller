...
public class SpacesTestAction extends Action{
	public ActionForward execute(
		...
		if(StringUtils.isNotBlank(req.getParameter("attachment"))) {
			Criteria criteria2 = session.createCriteria(Attachment.class);
			criteria2.add(Restrictions.idEq(Integer.valueOf(req.getParameter("attachment"))));
