	...
	public XlsExportOfPublicUserAction(Vector vector,OutputStream outputStream,Session session){
        ...
        try{
    		...
    		for (Iterator iter = vector.iterator(); iter.hasNext();) {
    			...
    			sheet.addCell(new Label(x++, y, publicUser.get().getTypename()));
    			sheet.addCell(new Label(x++, y, publicUser.get().getModelcode()));
    			sheet.addCell(new Label(x++, y, publicUser.get().getShimuke()));
    			sheet.addCell(new Label(x++, y, publicUser.get().getName()));
    			sheet.addCell(new Number(x++, y, publicUser.get()));
    			sheet.addCell(new Number(x++, y, publicUser.get()));
