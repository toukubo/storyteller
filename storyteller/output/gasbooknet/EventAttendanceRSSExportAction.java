...
public class EventAttendanceRSSExportAction extends Action{
...
//	    		##secoundclass## ##secoundobj## = eventAttendance.get##secoundclass##();
	    			criteria = session.createCriteria(EventAttendance.class);
...
//	    			criteria.add(Restrictions.eq("##secoundobj##", ##secoundobj##));
	    			...
	    			ChannelIF newChannel = builder.createChannel("EventAttendances");
	    			...
	    			newChannel.setDescription("EventAttendances");
					...
					//item.setDate(new Date());
	    				...
	    				item.setTitle(eventAttendance.getName());
	    				item.setLink(new URL("http://"+req.getServerName()+req.getRequestURI());
	    				item.setDescription(eventAttendance.getName());
	    			...
	    			PrintWriter printWriter = new PrintWriter(new File(this.getServlet().getServletContext().getRealPath("EventAttendanceRssExport.xml")),"utf-8");
