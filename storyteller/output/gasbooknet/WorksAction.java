...
Criteria criteriaSharedWorkXlsFile= session.createCriteria(SharedWorkXlsFile.class);
			req.setAttribute("SharedWorkXlsFiles", criteriaSharedWorkXlsFile.list());
