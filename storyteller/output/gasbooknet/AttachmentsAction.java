...
public class AttachmentsAction extends Action{
	public ActionForward execute(
		...
		req.setAttribute("attachments",vector);


                  Criteria criteriaWorkAttachment= session.createCriteria(WorkAttachment.class);
			req.setAttribute("WorkAttachments", criteriaWorkAttachment.list());
