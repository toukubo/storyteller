...
public class EventInputRssAction extends Action{
	public ActionForward execute(
		...
		while(enum.hasMoreElements()){
		  ...
		  while(items.hasMoreElements()){
                  	RssChannelItem item = (RssChannelItem) items.nextElement();	     		                Event event = new EventImpl();
			event.setContent(item.getItemDescription());
			event.setTitle(itemIf.getItemTitle());
