...
public class BrandRSSExportAction extends Action{
...
//	    		##secoundclass## ##secoundobj## = brand.get##secoundclass##();
...
//	    			criteria.add(Restrictions.eq("##secoundobj##", ##secoundobj##));
	    			...
	    			ChannelIF newChannel = builder.createChannel("Brands");
	    			...
	    			newChannel.setDescription("Brands");
					...
					//item.setDate(new Date());
	    				...
	    				item.setDescription(brand.getName());
	    			...
	    			PrintWriter printWriter = new PrintWriter(new File(this.getServlet().getServletContext().getRealPath("BrandRssExport.xml")),"utf-8");
