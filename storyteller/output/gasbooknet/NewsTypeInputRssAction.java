...
public class NewsTypeInputRssAction extends Action{
	public ActionForward execute(
		...
		while(enum.hasMoreElements()){
		  ...
		  while(items.hasMoreElements()){
                  	RssChannelItem item = (RssChannelItem) items.nextElement();	     		                NewsType newsType = new NewsTypeImpl();
			newsType.setContent(item.getItemDescription());
			newsType.setTitle(itemIf.getItemTitle());
