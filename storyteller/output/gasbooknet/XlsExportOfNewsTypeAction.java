...
public class XlsExportOfNewsTypeAction{
	public XlsExportOfNewsTypeAction(Vector vector,OutputStream outputStream,Session session){
        ...
        try{
    		...
    		for (Iterator iter = vector.iterator(); iter.hasNext();) {
    			...
    			sheet.addCell(new Label(x++, y, newsType.get().getTypename()));
    			sheet.addCell(new Label(x++, y, newsType.get().getModelcode()));
    			sheet.addCell(new Label(x++, y, newsType.get().getShimuke()));
    			sheet.addCell(new Label(x++, y, newsType.get().getName()));
    			sheet.addCell(new Number(x++, y, newsType.get()));
    			sheet.addCell(new Number(x++, y, newsType.get()));
