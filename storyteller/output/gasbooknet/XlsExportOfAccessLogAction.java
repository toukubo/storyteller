...
public class XlsExportOfAccessLogAction{
	public XlsExportOfAccessLogAction(Vector vector,OutputStream outputStream,Session session){
        ...
        try{
    		...
    		for (Iterator iter = vector.iterator(); iter.hasNext();) {
    			...
    			sheet.addCell(new Label(x++, y, accessLog.get().getTypename()));
    			sheet.addCell(new Label(x++, y, accessLog.get().getModelcode()));
    			sheet.addCell(new Label(x++, y, accessLog.get().getShimuke()));
    			sheet.addCell(new Label(x++, y, accessLog.get().getName()));
    			sheet.addCell(new Number(x++, y, accessLog.get()));
    			sheet.addCell(new Number(x++, y, accessLog.get()));
