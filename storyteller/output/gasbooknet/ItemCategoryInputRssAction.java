...
public class ItemCategoryInputRssAction extends Action{
	public ActionForward execute(
		...
		while(enum.hasMoreElements()){
		  ...
		  while(items.hasMoreElements()){
                  	RssChannelItem item = (RssChannelItem) items.nextElement();	     		                ItemCategory itemCategory = new ItemCategoryImpl();
			itemCategory.setContent(item.getItemDescription());
			itemCategory.setTitle(itemIf.getItemTitle());
