...
public class SetNewsTaggingNonNewsAction extends Action{
	public ActionForward execute(
		...
		newsTagging.setNews(false);
		session.saveOrUpdate(newsTagging);
		transaction.commit();
		session.flush();


		new HTTPGetRedirection(req, res, "NewsTaggings.do", newsTagging.getId().toString());
		return null;
	}
