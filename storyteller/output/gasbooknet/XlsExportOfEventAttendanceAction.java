...
public class XlsExportOfEventAttendanceAction{
	public XlsExportOfEventAttendanceAction(Vector vector,OutputStream outputStream,Session session){
        ...
        try{
    		...
    		for (Iterator iter = vector.iterator(); iter.hasNext();) {
    			...
    			sheet.addCell(new Label(x++, y, eventAttendance.get().getTypename()));
    			sheet.addCell(new Label(x++, y, eventAttendance.get().getModelcode()));
    			sheet.addCell(new Label(x++, y, eventAttendance.get().getShimuke()));
    			sheet.addCell(new Label(x++, y, eventAttendance.get().getName()));
    			sheet.addCell(new Number(x++, y, eventAttendance.get()));
    			sheet.addCell(new Number(x++, y, eventAttendance.get()));
