...
public class BrandInputRssAction extends Action{
	public ActionForward execute(
		...
		while(enum.hasMoreElements()){
		  ...
		  while(items.hasMoreElements()){
                  	RssChannelItem item = (RssChannelItem) items.nextElement();	     		                Brand brand = new BrandImpl();
			brand.setContent(item.getItemDescription());
			brand.setTitle(itemIf.getItemTitle());
