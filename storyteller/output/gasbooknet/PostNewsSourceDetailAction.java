...
public class PostNewsSourceDetailAction extends Action{
...
Criteria criteriaPartnerMedia= session.createCriteria(PartnerMedia.class);
			req.setAttribute("PartnerMedias", criteriaPartnerMedia.list());
