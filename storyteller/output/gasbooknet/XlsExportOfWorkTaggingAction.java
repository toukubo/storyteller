...
public class XlsExportOfWorkTaggingAction{
	public XlsExportOfWorkTaggingAction(Vector vector,OutputStream outputStream,Session session){
        ...
        try{
    		...
    		for (Iterator iter = vector.iterator(); iter.hasNext();) {
    			...
    			sheet.addCell(new Label(x++, y, workTagging.get().getTypename()));
    			sheet.addCell(new Label(x++, y, workTagging.get().getModelcode()));
    			sheet.addCell(new Label(x++, y, workTagging.get().getShimuke()));
    			sheet.addCell(new Label(x++, y, workTagging.get().getName()));
    			sheet.addCell(new Number(x++, y, workTagging.get()));
    			sheet.addCell(new Number(x++, y, workTagging.get()));
