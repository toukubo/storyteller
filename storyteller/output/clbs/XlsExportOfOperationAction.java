...
public class XlsExportOfOperationAction{
	public XlsExportOfOperationAction(Vector vector,OutputStream outputStream,Session session){
        ...
        try{
    		...
    		for (Iterator iter = vector.iterator(); iter.hasNext();) {
    			...
    			sheet.addCell(new Label(x++, y, operation.get().getTypename()));
    			sheet.addCell(new Label(x++, y, operation.get().getModelcode()));
    			sheet.addCell(new Label(x++, y, operation.get().getShimuke()));
    			sheet.addCell(new Label(x++, y, operation.get().getName()));
    			sheet.addCell(new Number(x++, y, operation.get()));
    			sheet.addCell(new Number(x++, y, operation.get()));
