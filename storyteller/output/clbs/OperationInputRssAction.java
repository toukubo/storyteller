...
public class OperationInputRssAction extends Action{
	public ActionForward execute(
		...
		while(enum.hasMoreElements()){
		  ...
		  while(items.hasMoreElements()){
                  	RssChannelItem item = (RssChannelItem) items.nextElement();	     		                Operation operation = new OperationImpl();
			operation.setContent(item.getItemDescription());
			operation.setTitle(itemIf.getItemTitle());
