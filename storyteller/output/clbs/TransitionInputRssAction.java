...
public class TransitionInputRssAction extends Action{
	public ActionForward execute(
		...
		while(enum.hasMoreElements()){
		  ...
		  while(items.hasMoreElements()){
                  	RssChannelItem item = (RssChannelItem) items.nextElement();	     		                Transition transition = new TransitionImpl();
			transition.setContent(item.getItemDescription());
			transition.setTitle(itemIf.getItemTitle());
