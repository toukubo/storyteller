...
public class KeywordsAction extends Action{
...
//<snippet sentence="KeywordsAction">
...
//		}
		...
		criteria = session.createCriteria(Keyword.class);
...
//     		    CsvExportKeywordsAction csvExportKeywordsAction 
//                               = new CsvExportKeywordsAction(req,session,Collection  collection);
//                }
