...
public class PostKeywordVPForQuotesAction extends Action{
	public ActionForward execute(
		...
		if(keywordform.getId() == null || keywordform.getId().intValue() == 0){
			...
			keyword = (Keyword) criteria.uniqueResult();
                		...
                		keyword.setSlug(keywordform.getSlug());
		keyword.setPermalink(keywordform.getPermalink());
		keyword.setHaspage(keywordform.getHaspage());
		keyword.setValue(keywordform.getValue());
