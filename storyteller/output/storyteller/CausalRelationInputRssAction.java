...
public class CausalRelationInputRssAction extends Action{
	public ActionForward execute(
		...
		while(enum.hasMoreElements()){
		  ...
		  while(items.hasMoreElements()){
                  	RssChannelItem item = (RssChannelItem) items.nextElement();	     		                CausalRelation causalRelation = new CausalRelationImpl();
			causalRelation.setContent(item.getItemDescription());
			causalRelation.setTitle(itemIf.getItemTitle());
