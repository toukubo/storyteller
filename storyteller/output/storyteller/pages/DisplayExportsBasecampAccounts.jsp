...
<display:column media="xml csv excel pdf" property="basecampProjects" title="basecampProjects"/>
<display:column media="xml csv excel pdf" property="apid" title="apid"/>
