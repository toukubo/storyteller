...
<display:column media="xml csv excel pdf" property="ordernum" title="ordernum"/>
<display:column media="xml csv excel pdf" property="basecampTodos" title="basecampTodos"/>
<display:column media="xml csv excel pdf" property="basecampProject" title="basecampProject"/>
