...
<nobr><input size="8" onblur="ajax(${row.id});" type="text" name="totalcost" id="${row.id}_totalcost" value="${row.totalcost}" /></nobr>
</display:column>
...
<nobr><input size="8" onblur="ajax(${row.id});" type="text" name="totalprice" id="${row.id}_totalprice" value="${row.totalprice}" /></nobr>
</display:column>
 <display:column media="html" sortable="true" title="採用">
<nobr><input size="8" onblur="ajax(${row.id});" type="text" name="adapted" id="${row.id}_adapted" value="${row.adapted}" /></nobr>
</display:column>
 <display:column media="html" sortable="true" title="totalsentencenum">
<nobr><input size="8" onblur="ajax(${row.id});" type="text" name="totalsentencenum" id="${row.id}_totalsentencenum" value="${row.totalsentencenum}" /></nobr>
</display:column>
 <display:column media="html" sortable="true" title="センテンス単価">
<nobr><input size="8" onblur="ajax(${row.id});" type="text" name="sentenceunit" id="${row.id}_sentenceunit" value="${row.sentenceunit}" /></nobr>
</display:column>
