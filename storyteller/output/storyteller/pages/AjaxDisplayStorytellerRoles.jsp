	...
	<meta http-equiv="Content-Type" content="text/html; charset=UTF-8"/>
		...
		<script src="rico.js" type="text/javascript"></script>
         <script type="text/javascript">
             function ajax(num) {
                 var ajaxRequest = new AjaxRequest('PostStorytellerRoleVP.do'); //Create AjaxRequest object
...
<span class="title">ロール一覧</span>
                    <display:table name="${storytellerRoles}" id="row" requestURI="StorytellerRoles.do"
                        ...
                        <a href="DeleteStorytellerRole.do?id=${row.id}">削除</a>
                        </display:column>
...
<span id="subform">
		...
		<form method="POST" action="PostStorytellerRoleVP.do">
...
<html:text name="form" property="name" /><br />
          ...
          <html:submit value="save" />
                        ...
                        <a href="StorytellerRoles.do">新規ロール作成</a>
</div>
