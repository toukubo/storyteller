...
public class PostTestVPAction extends Action{
	public ActionForward execute(
		...
		criteria2 = session.createCriteria(Responsible.class);
		criteria2.add(Restrictions.idEq(responsibleInt));
		Responsible responsible = (Responsible) criteria2.uniqueResult();
		test.setResponsible(responsible);
		criteria2 = session.createCriteria(Creator.class);
		criteria2.add(Restrictions.idEq(creatorInt));
		Creator creator = (Creator) criteria2.uniqueResult();
		test.setCreator(creator);
		criteria2 = session.createCriteria(Debugger.class);
		criteria2.add(Restrictions.idEq(debuggerInt));
		Debugger debugger = (Debugger) criteria2.uniqueResult();
