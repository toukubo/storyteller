...
public class CausalRelationRSSExportAction extends Action{
...
//	    		##secoundclass## ##secoundobj## = causalRelation.get##secoundclass##();
	    			criteria = session.createCriteria(CausalRelation.class);
...
//	    			criteria.add(Restrictions.eq("##secoundobj##", ##secoundobj##));
	    			...
	    			ChannelIF newChannel = builder.createChannel("CausalRelations");
	    			...
	    			newChannel.setDescription("CausalRelations");
					...
					//item.setDate(new Date());
	    				...
	    				item.setTitle(causalRelation.getName());
	    				item.setLink(new URL("http://"+req.getServerName()+req.getRequestURI());
	    				item.setDescription(causalRelation.getName());
	    			...
	    			PrintWriter printWriter = new PrintWriter(new File(this.getServlet().getServletContext().getRealPath("CausalRelationRssExport.xml")),"utf-8");
