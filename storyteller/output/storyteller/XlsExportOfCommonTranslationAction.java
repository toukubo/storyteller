	...
	public XlsExportOfCommonTranslationAction(Vector vector,OutputStream outputStream,Session session){
        ...
        try{
    		...
    		for (Iterator iter = vector.iterator(); iter.hasNext();) {
    			...
    			sheet.addCell(new Label(x++, y, commonTranslation.get().getTypename()));
    			sheet.addCell(new Label(x++, y, commonTranslation.get().getModelcode()));
    			sheet.addCell(new Label(x++, y, commonTranslation.get().getShimuke()));
    			sheet.addCell(new Label(x++, y, commonTranslation.get().getName()));
    			sheet.addCell(new Number(x++, y, commonTranslation.get()));
    			sheet.addCell(new Number(x++, y, commonTranslation.get()));
