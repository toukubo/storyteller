...
public class XlsExportOfCausalRelationAction{
	public XlsExportOfCausalRelationAction(Vector vector,OutputStream outputStream,Session session){
        ...
        try{
    		...
    		for (Iterator iter = vector.iterator(); iter.hasNext();) {
    			...
    			sheet.addCell(new Label(x++, y, causalRelation.get().getTypename()));
    			sheet.addCell(new Label(x++, y, causalRelation.get().getModelcode()));
    			sheet.addCell(new Label(x++, y, causalRelation.get().getShimuke()));
    			sheet.addCell(new Label(x++, y, causalRelation.get().getName()));
    			sheet.addCell(new Number(x++, y, causalRelation.get()));
    			sheet.addCell(new Number(x++, y, causalRelation.get()));
