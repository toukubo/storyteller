...
public class PostJ2eeStoryDetailAboutContributeAction extends Action{
	public ActionForward execute(
		...
		req.setAttribute("form",j2eeStoryform);
                  ...
                  Criteria criteriaContribute= session.createCriteria(Contribute.class);
			req.setAttribute("Contributes", criteriaContribute.list());
