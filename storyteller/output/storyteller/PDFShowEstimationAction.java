...
public class PDFShowEstimationAction extends Action{
	public ActionForward execute(
	   ...
	   cb.lineTo(this.xoffset + 300,this.max - (this.yoffset + 260));
            ...
            cb.setFontAndSize(bf, 12);
            cb.showTextAligned(PdfContentByte.ALIGN_LEFT,"見積No:　　" + estimation.getId(),this.xoffset + 400,this.max - (this.yoffset + 10) ,0);
            ...
            if(estimation.getCustomer()!=null){
            	cb.showTextAligned(PdfContentByte.ALIGN_LEFT,estimation.getCustomer().getName(),this.xoffset ,this.max - (this.yoffset + 45) ,0);
            	cb.showTextAligned(PdfContentByte.ALIGN_LEFT,estimation.getCustomer().getTitle() ,this.xoffset +200  ,this.max - (this.yoffset + 45) ,0);
            }
            ...
            StringTokenizer stringTokenizer = new StringTokenizer(estimation.getName(),"\r\n");
            if(stringTokenizer.countTokens()!=1){
            	...
            	cb.showTextAligned(PdfContentByte.ALIGN_LEFT,estimation.getName(),this.xoffset + 95,this.max - (this.yoffset + 190) ,0);
            }
...
cb.showTextAligned(PdfContentByte.ALIGN_LEFT, StringUtils.estimation.getId().toString(),this.xoffset + 103,this.max - (this.yoffset + 350),0);

cb.showTextAligned(PdfContentByte.ALIGN_LEFT, "トータルコスト",this.xoffset + 103,this.max - (this.yoffset + 365),0);
cb.showTextAligned(PdfContentByte.ALIGN_LEFT, new Integer(estimation.getTotalcost()).toString(),this.xoffset + 103,this.max - (this.yoffset + 365),0);

cb.showTextAligned(PdfContentByte.ALIGN_LEFT, "ストーリー",this.xoffset + 103,this.max - (this.yoffset + 380),0);

cb.showTextAligned(PdfContentByte.ALIGN_LEFT, "合計金額",this.xoffset + 103,this.max - (this.yoffset + 395),0);
cb.showTextAligned(PdfContentByte.ALIGN_LEFT, new Integer(estimation.getTotalprice()).toString(),this.xoffset + 103,this.max - (this.yoffset + 395),0);

cb.showTextAligned(PdfContentByte.ALIGN_LEFT, "採用",this.xoffset + 103,this.max - (this.yoffset + 410),0);

cb.showTextAligned(PdfContentByte.ALIGN_LEFT, "totalsentencenum",this.xoffset + 103,this.max - (this.yoffset + 425),0);
cb.showTextAligned(PdfContentByte.ALIGN_LEFT, new Integer(estimation.getTotalsentencenum()).toString(),this.xoffset + 103,this.max - (this.yoffset + 425),0);

cb.showTextAligned(PdfContentByte.ALIGN_LEFT, "センテンス単価",this.xoffset + 103,this.max - (this.yoffset + 440),0);
cb.showTextAligned(PdfContentByte.ALIGN_LEFT, new Integer(estimation.getSentenceunit()).toString(),this.xoffset + 103,this.max - (this.yoffset + 440),0);

cb.showTextAligned(PdfContentByte.ALIGN_LEFT, "見積内訳",this.xoffset + 103,this.max - (this.yoffset + 455),0);
...
cb.showTextAligned(PdfContentByte.ALIGN_LEFT, StringUtils.estimationchoise.getId().toString(),this.xoffset + 103,this.max - (this.yoffset + 470),0);

cb.showTextAligned(PdfContentByte.ALIGN_LEFT, "金額",this.xoffset + 103,this.max - (this.yoffset + 485),0);
cb.showTextAligned(PdfContentByte.ALIGN_LEFT, new Integer(estimationchoise.getPrice()).toString(),this.xoffset + 103,this.max - (this.yoffset + 485),0);

cb.showTextAligned(PdfContentByte.ALIGN_LEFT, "タスク",this.xoffset + 103,this.max - (this.yoffset + 500),0);

cb.showTextAligned(PdfContentByte.ALIGN_LEFT, "原価",this.xoffset + 103,this.max - (this.yoffset + 515),0);
cb.showTextAligned(PdfContentByte.ALIGN_LEFT, new Integer(estimationchoise.getCost()).toString(),this.xoffset + 103,this.max - (this.yoffset + 515),0);

cb.showTextAligned(PdfContentByte.ALIGN_LEFT, "利潤",this.xoffset + 103,this.max - (this.yoffset + 530),0);
cb.showTextAligned(PdfContentByte.ALIGN_LEFT, new Integer(estimationchoise.getProfilt()).toString(),this.xoffset + 103,this.max - (this.yoffset + 530),0);

cb.showTextAligned(PdfContentByte.ALIGN_LEFT, "見積",this.xoffset + 103,this.max - (this.yoffset + 545),0);
