...
public class CommonTranslationInputRssAction extends Action{
	public ActionForward execute(
		...
		while(enum.hasMoreElements()){
		  ...
		  while(items.hasMoreElements()){
                  	RssChannelItem item = (RssChannelItem) items.nextElement();	     		                CommonTranslation commonTranslation = new CommonTranslationImpl();
			commonTranslation.setContent(item.getItemDescription());
			commonTranslation.setTitle(itemIf.getItemTitle());
