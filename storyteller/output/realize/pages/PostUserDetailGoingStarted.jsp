...
<html:text name="form" property="paidcommition" /><br />
                                ...
                                introductionsAsIntroduced<br />
                                <c:choose>
                                    <c:when test="${empty IntroductionsAsIntroduceds}">
                                         <select name="introductionsAsIntroduced" disabled="disabled"/>
                                    </c:when>
                                    <c:otherwise>
                                        <select name="introductionsAsIntroduced" ><option value=""></option>
                                            <c:forEach var="valueLabel" items="${IntroductionsAsIntroduceds}">
                                                <c:choose>
                                                    <c:when test="${valueLabel.id eq model.introductionsAsIntroduced.id}">
...
started<br />
<html:checkbox name="form" property="started" /><br />

startsWithIntroduction<br />
<html:checkbox name="form" property="startsWithIntroduction" /><br />
