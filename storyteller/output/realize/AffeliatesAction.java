...
public class AffeliatesAction extends Action{
...
//<snippet sentence="AffeliatesAction">


//                Vector vector = new Vector();
		Criteria criteria = session.createCriteria(Affeliate.class);
                
		req.setAttribute("affeliates",criteria.list());


//		for (Iterator iter = criteria.list().iterator(); iter.hasNext();) {
//			Affeliate affeliate = (Affeliate) iter.next();
//			vector.add(affeliate);
//		}
		Affeliate affeliate = new AffeliateImpl();
		AffeliateForm affeliateform = new AffeliateForm();
		criteria = session.createCriteria(Affeliate.class);
...
//     		    CsvExportAffeliatesAction csvExportAffeliatesAction 
//                               = new CsvExportAffeliatesAction(req,session,Collection  collection);
//                }
