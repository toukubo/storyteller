...
public class UpdateAtOnceLikingActionByCrawlerAction extends Action{
	...
	public static void main(String[] args) {
		try {
				...
				UpdateAtOnceLikingActionByCrawlerAction action = new UpdateAtOnceLikingActionByCrawlerAction();
				Criteria criteria = session.createCriteria(Liking.class);
	...
	public void execute(List list,Session session){
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			Liking liking = (Liking) iter.next();
                           //operation here.
