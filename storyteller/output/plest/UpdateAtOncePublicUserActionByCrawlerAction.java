...
public class UpdateAtOncePublicUserActionByCrawlerAction extends Action{
	...
	public static void main(String[] args) {
		try {
				...
				UpdateAtOncePublicUserActionByCrawlerAction action = new UpdateAtOncePublicUserActionByCrawlerAction();
				Criteria criteria = session.createCriteria(PublicUser.class);
