...
public class UpdateAtOnceShareActionByCrawlerAction extends Action{
	...
	public static void main(String[] args) {
		try {
				...
				UpdateAtOnceShareActionByCrawlerAction action = new UpdateAtOnceShareActionByCrawlerAction();
				Criteria criteria = session.createCriteria(Share.class);
