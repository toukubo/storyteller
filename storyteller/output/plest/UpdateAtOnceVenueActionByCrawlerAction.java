...
public class UpdateAtOnceVenueActionByCrawlerAction extends Action{
	...
	public static void main(String[] args) {
		try {
				...
				UpdateAtOnceVenueActionByCrawlerAction action = new UpdateAtOnceVenueActionByCrawlerAction();
				Criteria criteria = session.createCriteria(Venue.class);
