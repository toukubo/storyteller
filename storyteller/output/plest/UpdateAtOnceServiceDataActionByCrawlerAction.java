...
public class UpdateAtOnceServiceDataActionByCrawlerAction extends Action{
	...
	public static void main(String[] args) {
		try {
				...
				UpdateAtOnceServiceDataActionByCrawlerAction action = new UpdateAtOnceServiceDataActionByCrawlerAction();
				Criteria criteria = session.createCriteria(ServiceData.class);
	...
	public void execute(List list,Session session){
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			ServiceData serviceData = (ServiceData) iter.next();
                           //operation here.
