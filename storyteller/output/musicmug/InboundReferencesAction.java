...
public class InboundReferencesAction extends Action{
	public ActionForward execute(
		...
		for (Iterator iter = criteria.list().iterator(); iter.hasNext();) {
			InboundReference inboundReference = (InboundReference) iter.next();
			vector.add(inboundReference);
		}
		...
		criteria = session.createCriteria(InboundReference.class);
		...
		req.setAttribute("model",inboundReference);
		req.setAttribute("form",inboundReferenceform);
		
		
		req.setAttribute("inboundReferences",vector);
