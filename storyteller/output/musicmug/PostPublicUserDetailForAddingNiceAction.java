...
public class PostPublicUserDetailForAddingNiceAction extends Action{
	public ActionForward execute(
		...
		req.setAttribute("form",publicUserform);
                  ...
                  Criteria criteriaSkin= session.createCriteria(Skin.class);
			req.setAttribute("Skins", criteriaSkin.list());
