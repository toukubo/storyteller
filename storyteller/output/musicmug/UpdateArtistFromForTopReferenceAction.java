...
public class UpdateArtistFromForTopReferenceAction extends Action{
	...
	public static void main(String[] args) {
		try {
				...
				UpdateArtistFromForTopReferenceAction action = new UpdateArtistFromForTopReferenceAction();
				Criteria criteria = session.createCriteria(Artist.class);
