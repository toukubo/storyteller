...
public class MusicCategorysAction extends Action{
	public ActionForward execute(
		...
		for (Iterator iter = criteria.list().iterator(); iter.hasNext();) {
			MusicCategory musicCategory = (MusicCategory) iter.next();
			vector.add(musicCategory);
		}
		MusicCategory musicCategory = new MusicCategoryImpl();
		MusicCategoryForm musicCategoryform = new MusicCategoryForm();
		criteria = session.createCriteria(MusicCategory.class);
		...
		req.setAttribute("musicCategorys",vector);
