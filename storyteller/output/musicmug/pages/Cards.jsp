...
<span class="title">一覧</span>
                    <display:table name="${cards}" id="row" requestURI="Cards.do"
                            requestURIcontext="false"
                            export="false" pagesize="30" sort="list">
                        <display:column media="html" sortable="false">
                        <a href="Cards.do?id=${row.id}">編集</a>
                        <a href="DeleteCard.do?id=${row.id}">削除</a>
                        </display:column>
...
<a href="Cards.do?d-16544-e=1&6578706f7274=1&displayexport">
CVS
</a>
<a href="Cards.do?d-16544-e=2&6578706f7274=1&displayexport">
XLS
</a>
<a href="Cards.do?d-16544-e=3&6578706f7274=1&displayexport">
XML
</a>
<a href="Cards.do?d-16544-e=4&6578706f7274=1&displayexport">
PDF
</a>
...
<span id="subform">
		...
		<form method="POST" action="PostCardVP.do">
