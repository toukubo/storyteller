...
public class PostPublicUserVPForAddingNiceAction extends Action{
	public ActionForward execute(
		...
		PublicUserForm publicUserform = (PublicUserForm) form;
                ...
                String error = "";
                		...
                		Integer skinInt = publicUserform.getSkin();
		publicUserform.setSkin(null);
		...
		StringFullfiller.fullfil(publicUser);
                		Criteria criteria2 = session.createCriteria(Skin.class);
		criteria2.add(Restrictions.idEq(skinInt));
		Skin skin = (Skin) criteria2.uniqueResult();
		publicUser.setSkin(skin);
