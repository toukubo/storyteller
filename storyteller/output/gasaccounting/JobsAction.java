...
public class JobsAction extends Action{
	public ActionForward execute(
		...
		criteria = session.createCriteria(Job.class);
		...
		req.setAttribute("jobs",vector);


                  Criteria criteriaJobCategory= session.createCriteria(JobCategory.class);
			req.setAttribute("JobCategorys", criteriaJobCategory.list());
