...
public class SalaryPaymentsAction extends Action{
	public ActionForward execute(
		...
		for (Iterator iter = criteria.list().iterator(); iter.hasNext();) {
			SalaryPayment salarypayment = (SalaryPayment) iter.next();
			vector.add(salarypayment);
		}
		SalaryPayment salarypayment = new SalaryPaymentImpl();
		SalaryPaymentForm salarypaymentform = new SalaryPaymentForm();
		criteria = session.createCriteria(SalaryPayment.class);
		...
		req.setAttribute("salarypayments",vector);
