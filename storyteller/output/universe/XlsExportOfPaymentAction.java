...
public class XlsExportOfPaymentAction{
	public XlsExportOfPaymentAction(Vector vector,OutputStream outputStream,Session session){
        ...
        try{
    		...
    		for (Iterator iter = vector.iterator(); iter.hasNext();) {
    			...
    			sheet.addCell(new Label(x++, y, payment.get().getTypename()));
    			sheet.addCell(new Label(x++, y, payment.get().getModelcode()));
    			sheet.addCell(new Label(x++, y, payment.get().getShimuke()));
    			sheet.addCell(new Label(x++, y, payment.get().getName()));
    			sheet.addCell(new Number(x++, y, payment.get()));
    			sheet.addCell(new Number(x++, y, payment.get()));
