...
public class PostPaymentVPForSettingPayedAction extends Action{
	public ActionForward execute(
		...
		Integer contractDetailInt = paymentform.getContractDetail();
		paymentform.setContractDetail(null);
		...
		payment.setPayment(paymentform.isPayment());
		payment.setPaid(paymentform.isPaid());
		...
		criteria2 = session.createCriteria(ContractDetail.class);
		criteria2.add(Restrictions.idEq(contractDetailInt));
		ContractDetail contractdetail = (ContractDetail) criteria2.uniqueResult();
		payment.setContractDetail(contractdetail);
