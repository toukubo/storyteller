	...
	public ActionForward execute(
		...
		if(staticDataform.getId() == null || staticDataform.getId().intValue() == 0){
			...
			staticData = (StaticData) criteria.uniqueResult();
                		...
                		staticData.setManagementrate(staticDataform.getManagementrate());
		staticData.setDivisionthreshold(staticDataform.getDivisionthreshold());
		staticData.setReceivedeadline(staticDataform.getReceivedeadline());
		staticData.setPaymentdeadline(staticDataform.getPaymentdeadline());
		...
		staticData.setMarginrate(staticDataform.getMarginrate());
