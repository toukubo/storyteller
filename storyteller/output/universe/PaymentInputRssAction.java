...
public class PaymentInputRssAction extends Action{
	public ActionForward execute(
		...
		while(enum.hasMoreElements()){
		  ...
		  while(items.hasMoreElements()){
                  	RssChannelItem item = (RssChannelItem) items.nextElement();	     		                Payment payment = new PaymentImpl();
			payment.setContent(item.getItemDescription());
			payment.setTitle(itemIf.getItemTitle());
