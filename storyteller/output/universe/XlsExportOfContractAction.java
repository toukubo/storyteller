...
public class XlsExportOfContractAction{
	public XlsExportOfContractAction(Vector vector,OutputStream outputStream,Session session){
        ...
        try{
    		...
    		for (Iterator iter = vector.iterator(); iter.hasNext();) {
    			...
    			sheet.addCell(new Label(x++, y, contract.get().getTypename()));
    			sheet.addCell(new Label(x++, y, contract.get().getModelcode()));
    			sheet.addCell(new Label(x++, y, contract.get().getShimuke()));
    			sheet.addCell(new Label(x++, y, contract.get().getName()));
    			sheet.addCell(new Number(x++, y, contract.get()));
    			sheet.addCell(new Number(x++, y, contract.get()));
