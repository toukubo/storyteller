...
public class ContractInputRssAction extends Action{
	public ActionForward execute(
		...
		while(enum.hasMoreElements()){
		  ...
		  while(items.hasMoreElements()){
                  	RssChannelItem item = (RssChannelItem) items.nextElement();	     		                Contract contract = new ContractImpl();
			contract.setContent(item.getItemDescription());
			contract.setTitle(itemIf.getItemTitle());
