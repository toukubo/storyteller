...
</div>				<display:table name="publicuser.accounts" id="row" requestURI="ForPurchases.do" pagesize="0" 
...
</div>				<display:table name="publicuser.purchases" id="row" requestURI="ForPurchases.do" pagesize="0" 
 requestURIcontext="false" sort="list" export="false" >
 <display:column media="html" sortable="true" title="ID" property="id" >
