	...
	public ActionForward execute(
		...
		if(staticDataform.getId() == null || staticDataform.getId().intValue() == 0){
			...
			staticData = (StaticData) criteria.uniqueResult();
                		...
                		staticData.setPassword(staticDataform.getPassword());
		staticData.setMail(staticDataform.getMail());
		...
		staticData.setSystemnewsrssimporturl(staticDataform.getSystemnewsrssimporturl());
		staticData.setBaseprice(staticDataform.getBaseprice());
