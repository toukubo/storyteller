...
public class PostMovieVPAction extends Action{
	public ActionForward execute(
		...
		if(movieform.getId() == null || movieform.getId().intValue() == 0){
			...
			movie = (Movie) criteria.uniqueResult();
                		...
                		movie.setSoundFk(movieform.getSoundFk());
		movie.setSize(movieform.getSize());
		movie.setBackground(movieform.getBackground());
