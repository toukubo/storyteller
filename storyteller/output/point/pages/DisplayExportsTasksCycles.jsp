...
<display:column media="xml csv excel pdf" property="value" title="value"/>
<display:column media="xml csv excel pdf" property="done" title="done"/>
<display:column media="xml csv excel pdf" property="date" title="date"/>
<display:column media="xml csv excel pdf" property="template" title="template"/>
<display:column media="xml csv excel pdf" property="duration" title="duration"/>
