...
public class ShopInputRssAction extends Action{
	public ActionForward execute(
		...
		while(enum.hasMoreElements()){
		  ...
		  while(items.hasMoreElements()){
                  	RssChannelItem item = (RssChannelItem) items.nextElement();	     		                Shop shop = new ShopImpl();
			shop.setContent(item.getItemDescription());
			shop.setTitle(itemIf.getItemTitle());
