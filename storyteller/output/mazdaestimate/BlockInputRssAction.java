...
public class BlockInputRssAction extends Action{
	public ActionForward execute(
		...
		while(enum.hasMoreElements()){
		  ...
		  while(items.hasMoreElements()){
                  	RssChannelItem item = (RssChannelItem) items.nextElement();	     		                Block block = new BlockImpl();
			block.setContent(item.getItemDescription());
			block.setTitle(itemIf.getItemTitle());
