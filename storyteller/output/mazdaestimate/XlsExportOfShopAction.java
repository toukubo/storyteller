...
public class XlsExportOfShopAction{
	public XlsExportOfShopAction(Vector vector,OutputStream outputStream,Session session){
        ...
        try{
    		...
    		for (Iterator iter = vector.iterator(); iter.hasNext();) {
    			...
    			sheet.addCell(new Label(x++, y, shop.get().getTypename()));
    			sheet.addCell(new Label(x++, y, shop.get().getModelcode()));
    			sheet.addCell(new Label(x++, y, shop.get().getShimuke()));
    			sheet.addCell(new Label(x++, y, shop.get().getName()));
    			sheet.addCell(new Number(x++, y, shop.get()));
    			sheet.addCell(new Number(x++, y, shop.get()));
