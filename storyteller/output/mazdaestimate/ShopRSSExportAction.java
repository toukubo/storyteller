...
public class ShopRSSExportAction extends Action{
...
//	    		##secoundclass## ##secoundobj## = shop.get##secoundclass##();
...
//	    			criteria.add(Restrictions.eq("##secoundobj##", ##secoundobj##));
	    			...
	    			ChannelIF newChannel = builder.createChannel("Shops");
	    			...
	    			newChannel.setDescription("Shops");
					...
					//item.setDate(new Date());
	    				...
	    				item.setDescription(shop.getName());
	    			...
	    			PrintWriter printWriter = new PrintWriter(new File(this.getServlet().getServletContext().getRealPath("ShopRssExport.xml")),"utf-8");
