...
<display:column media="xml csv excel pdf" property="customerabnonaffirmationvisit" title="来店接客数確約外来店"/>
<display:column media="xml csv excel pdf" property="customernonabaffirmationvisit" title="来店接客数NONAB確約来店"/>
<display:column media="xml csv excel pdf" property="customernonabnonaffirmationvisit" title="来店接客数確約外来店"/>
