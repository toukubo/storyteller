...
<display:column media="xml csv excel pdf" property="exhibitionIntraUser" title="exhibitionIntraUser"/>
<display:column media="xml csv excel pdf" property="exhibitionReports" title="exhibitionReports"/>
<display:column media="xml csv excel pdf" property="exhibitionReportUseds" title="exhibitionReportUseds"/>
