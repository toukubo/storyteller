...
public class UpdateAtOnceEMailActionForSyncGmailToHighriseAction extends Action{
	...
	public static void main(String[] args) {
		try {
				...
				UpdateAtOnceEMailActionForSyncGmailToHighriseAction action = new UpdateAtOnceEMailActionForSyncGmailToHighriseAction();
				Criteria criteria = session.createCriteria(EMail.class);
