...
public class IntraUserInputRssAction extends Action{
	public ActionForward execute(
		...
		while(enum.hasMoreElements()){
		  ...
		  while(items.hasMoreElements()){
                  	RssChannelItem item = (RssChannelItem) items.nextElement();	     		                IntraUser intraUser = new IntraUserImpl();
			intraUser.setContent(item.getItemDescription());
			intraUser.setTitle(itemIf.getItemTitle());
