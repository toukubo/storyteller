...
public class XlsExportOfInstrumentAction{
	public XlsExportOfInstrumentAction(Vector vector,OutputStream outputStream,Session session){
        ...
        try{
    		...
    		for (Iterator iter = vector.iterator(); iter.hasNext();) {
    			...
    			sheet.addCell(new Label(x++, y, instrument.get().getTypename()));
    			sheet.addCell(new Label(x++, y, instrument.get().getModelcode()));
    			sheet.addCell(new Label(x++, y, instrument.get().getShimuke()));
    			sheet.addCell(new Label(x++, y, instrument.get().getName()));
    			sheet.addCell(new Number(x++, y, instrument.get()));
    			sheet.addCell(new Number(x++, y, instrument.get()));
