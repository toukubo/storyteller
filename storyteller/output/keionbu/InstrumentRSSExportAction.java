...
public class InstrumentRSSExportAction extends Action{
...
//	    		##secoundclass## ##secoundobj## = instrument.get##secoundclass##();
...
//	    			criteria.add(Restrictions.eq("##secoundobj##", ##secoundobj##));
	    			...
	    			ChannelIF newChannel = builder.createChannel("Instruments");
	    			...
	    			newChannel.setDescription("Instruments");
					...
					//item.setDate(new Date());
	    				...
	    				item.setTitle(instrument.getName());
	    				item.setLink(new URL("http://"+req.getServerName()+req.getRequestURI());
	    				item.setDescription(instrument.getName());
	    			...
	    			PrintWriter printWriter = new PrintWriter(new File(this.getServlet().getServletContext().getRealPath("InstrumentRssExport.xml")),"utf-8");
