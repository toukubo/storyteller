...
public class InstrumentInputRssAction extends Action{
	public ActionForward execute(
		...
		while(enum.hasMoreElements()){
		  ...
		  while(items.hasMoreElements()){
                  	RssChannelItem item = (RssChannelItem) items.nextElement();	     		                Instrument instrument = new InstrumentImpl();
			instrument.setContent(item.getItemDescription());
			instrument.setTitle(itemIf.getItemTitle());
