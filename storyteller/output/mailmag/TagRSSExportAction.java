...
public class TagRSSExportAction extends Action{
...
//	    		##secoundclass## ##secoundobj## = tag.get##secoundclass##();
...
//	    			criteria.add(Restrictions.eq("##secoundobj##", ##secoundobj##));
	    			...
	    			ChannelIF newChannel = builder.createChannel("Tags");
	    			...
	    			newChannel.setDescription("Tags");
					...
					//item.setDate(new Date());
	    				...
	    				item.setDescription(tag.getName());
	    			...
	    			PrintWriter printWriter = new PrintWriter(new File(this.getServlet().getServletContext().getRealPath("TagRssExport.xml")),"utf-8");
