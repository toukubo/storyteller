...
public class XlsExportOfTagAction{
	public XlsExportOfTagAction(Vector vector,OutputStream outputStream,Session session){
        ...
        try{
    		...
    		for (Iterator iter = vector.iterator(); iter.hasNext();) {
    			...
    			sheet.addCell(new Label(x++, y, tag.get().getTypename()));
    			sheet.addCell(new Label(x++, y, tag.get().getModelcode()));
    			sheet.addCell(new Label(x++, y, tag.get().getShimuke()));
    			sheet.addCell(new Label(x++, y, tag.get().getName()));
    			sheet.addCell(new Number(x++, y, tag.get()));
    			sheet.addCell(new Number(x++, y, tag.get()));
