...
public class PostStaticDataVPForHeaderAndFooterAction extends Action{
	public ActionForward execute(
		...
		if(staticDataform.getId() == null || staticDataform.getId().intValue() == 0){
			...
			staticData = (StaticData) criteria.uniqueResult();
                		...
                		staticData.setHeader(staticDataform.getHeader());
		staticData.setFooter(staticDataform.getFooter());
		staticData.setFromaddress(staticDataform.getFromaddress());
		staticData.setSitename(staticDataform.getSitename());
		staticData.setMediaserverurl(staticDataform.getMediaserverurl());
		staticData.setUnix(staticDataform.isUnix());
		staticData.setBasepath(staticDataform.getBasepath());
		staticData.setSleepsecound(staticDataform.getSleepsecound());
		staticData.setErroraddress(staticDataform.getErroraddress());
