...
public class TagInputRssAction extends Action{
	public ActionForward execute(
		...
		while(enum.hasMoreElements()){
		  ...
		  while(items.hasMoreElements()){
                  	RssChannelItem item = (RssChannelItem) items.nextElement();	     		                Tag tag = new TagImpl();
			tag.setContent(item.getItemDescription());
			tag.setTitle(itemIf.getItemTitle());
