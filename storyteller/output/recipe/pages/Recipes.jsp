...
<tiles:insert definition=".layout">
	<tiles:put name="title" value="レシピ一覧" direct="true" />
	<tiles:put name="content" direct="true">
<table align="right">
	<tr>
	<div>	
		<td>
			<form action="GrepRecipe.do">
...
<input type="submit" value="Go" onclick="document.publicusers1.action='PublicUsers.do'"> 
                    ...
                    <display:table name="${recipes}" id="row" requestURI="Recipes.do"
                            requestURIcontext="false"
                            export="false" pagesize="30" sort="list">
                        <display:column media="html" sortable="false">
                        <a href="ShowRecipe.do?id=${row.id}">Show</a> | 
                        <a href="PostRecipeDetail.do?id=${row.id}"><img src="icons/table_edit.png"></a>
                        <a href="DeleteRecipe.do?id=${row.id}">削除</a>
                        </display:column>
