...
public class PostPublicUserDetailForAdminAction extends Action{
...
Criteria criteriaMpaMarking= session.createCriteria(MpaMarking.class);
			req.setAttribute("MpaMarkings", criteriaMpaMarking.list());

Criteria criteriaInvitation= session.createCriteria(Invitation.class);
			req.setAttribute("Invitations", criteriaInvitation.list());
