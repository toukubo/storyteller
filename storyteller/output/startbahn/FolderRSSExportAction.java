...
public class FolderRSSExportAction extends Action{
...
//	    		##secoundclass## ##secoundobj## = folder.get##secoundclass##();
	    			criteria = session.createCriteria(Folder.class);
...
//	    			criteria.add(Restrictions.eq("##secoundobj##", ##secoundobj##));
	    			...
	    			ChannelIF newChannel = builder.createChannel("Folders");
	    			...
	    			newChannel.setDescription("Folders");
					...
					//item.setDate(new Date());
	    				...
	    				item.setDescription(folder.getName());
	    			...
	    			PrintWriter printWriter = new PrintWriter(new File(this.getServlet().getServletContext().getRealPath("FolderRssExport.xml")),"utf-8");
