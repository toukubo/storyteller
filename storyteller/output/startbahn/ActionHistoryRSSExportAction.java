...
public class ActionHistoryRSSExportAction extends Action{
...
//	    		##secoundclass## ##secoundobj## = actionHistory.get##secoundclass##();
	    			criteria = session.createCriteria(ActionHistory.class);
...
//	    			criteria.add(Restrictions.eq("##secoundobj##", ##secoundobj##));
	    			...
	    			ChannelIF newChannel = builder.createChannel("ActionHistorys");
	    			...
	    			newChannel.setDescription("ActionHistorys");
					...
					//item.setDate(new Date());
	    				...
	    				item.setTitle(actionHistory.getName());
	    				item.setLink(new URL("http://"+req.getServerName()+req.getRequestURI());
	    				item.setDescription(actionHistory.getName());
	    			...
	    			PrintWriter printWriter = new PrintWriter(new File(this.getServlet().getServletContext().getRealPath("ActionHistoryRssExport.xml")),"utf-8");
