...
public class ForumCommentsAction extends Action{
	public ActionForward execute(
		...
		req.setAttribute("forumComments",criteria.list());


//		for (Iterator iter = criteria.list().iterator(); iter.hasNext();) {
//			ForumComment forumComment = (ForumComment) iter.next();
//			vector.add(forumComment);
//		}
		ForumComment forumComment = new ForumCommentImpl();
		ForumCommentForm forumCommentform = new ForumCommentForm();
		criteria = session.createCriteria(ForumComment.class);
