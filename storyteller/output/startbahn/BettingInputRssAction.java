...
public class BettingInputRssAction extends Action{
	public ActionForward execute(
		...
		while(enum.hasMoreElements()){
		  ...
		  while(items.hasMoreElements()){
                  	RssChannelItem item = (RssChannelItem) items.nextElement();	     		                Betting betting = new BettingImpl();
			betting.setContent(item.getItemDescription());
			betting.setTitle(itemIf.getItemTitle());
