...
public class XlsExportOfActionHistoryAction{
	public XlsExportOfActionHistoryAction(Vector vector,OutputStream outputStream,Session session){
        ...
        try{
    		...
    		for (Iterator iter = vector.iterator(); iter.hasNext();) {
    			...
    			sheet.addCell(new Label(x++, y, actionHistory.get().getTypename()));
    			sheet.addCell(new Label(x++, y, actionHistory.get().getModelcode()));
    			sheet.addCell(new Label(x++, y, actionHistory.get().getShimuke()));
    			sheet.addCell(new Label(x++, y, actionHistory.get().getName()));
    			sheet.addCell(new Number(x++, y, actionHistory.get()));
    			sheet.addCell(new Number(x++, y, actionHistory.get()));
