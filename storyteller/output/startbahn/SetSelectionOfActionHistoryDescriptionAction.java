...
public class SetSelectionOfActionHistoryDescriptionAction extends Action{
	public ActionForward execute(
		...
		for (int I = 0; I < req.getParameterValues("id").length; i++) {
			...
			ActionHistory actionHistory = (ActionHistory)criteria2.uniqueResult();
			actionHistory.setdescription(true);
