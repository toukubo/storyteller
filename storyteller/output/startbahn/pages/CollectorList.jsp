...
<div class="main">
    ...
    <logic:iterate id="model" name="collectors">
         id
${collector.id}
<br/>
一般ユーザー
...
</div>				<display:table name="collector.purchases" id="row" requestURI=".do" pagesize="0" 
...
</div>				<display:table name="collector.bettings" id="row" requestURI=".do" pagesize="0" 
 requestURIcontext="false" sort="list" export="false" >
 <display:column media="html" sortable="true" title="ID" property="id" >
...
</div>				<display:table name="collector.auctions" id="row" requestURI=".do" pagesize="0" 
 requestURIcontext="false" sort="list" export="false" >
 <display:column media="html" sortable="true" title="ID" property="id" >
