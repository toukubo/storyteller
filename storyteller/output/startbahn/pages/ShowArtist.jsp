...
プロフィール
<div>
<logic:iterate id="historicalProfile" name="artist" property="historicalProfiles">id
${historicalprofile.id}
<br/>
アーティスト
${historicalprofile.artist}
<br/>
説明
${historicalprofile.description}
<br/>
日付
date<st:date date="${historicalprofile.一般ユーザー
${artist.publicUser}
<br/>
portrait
${artist.portrait}
...
</div>				<display:table name="artist.historicalProfiles" id="row" requestURI=".do" pagesize="0" 
...
<br/>
履歴
				<display:table name="artist.actionHistories" id="row" requestURI=".do" pagesize="0" 
 requestURIcontext="false" sort="list" export="false" >
                        </display:table>
<br/>
作品
...
<br/>
日付
date<st:date date="${auction.一般ユーザー
${artist.publicUser}
<br/>
portrait
${artist.portrait}
...
</div>				<display:table name="work.auctions" id="row" requestURI=".do" pagesize="0" 
 requestURIcontext="false" sort="list" export="false" >
 <display:column media="html" sortable="true" title="ID" property="id" >
...
<st:date date="${row.date}" /> </nobr>
 ...
 <display:column media="html" sortable="true" title="currentprice">
<nobr>
${row.currentprice}
</nobr>
</display:column>
 <display:column media="html" sortable="true" title="startprice">
<nobr>
${row.startprice}
</nobr>
</display:column>
 <display:column media="html" sortable="true" title="active">
<nobr>
${row.active}
</nobr>
</display:column>
...
<br/>
日付
date<st:date date="${containing.一般ユーザー
${artist.publicUser}
<br/>
portrait
${artist.portrait}
...
</div>				<display:table name="work.containings" id="row" requestURI=".do" pagesize="0" 
 requestURIcontext="false" sort="list" export="false" >
 <display:column media="html" sortable="true" title="ID" property="id" >
...
<br/>
日付
date<st:date date="${review.一般ユーザー
${artist.publicUser}
<br/>
portrait
${artist.portrait}
...
</div>				<display:table name="work.reviews" id="row" requestURI=".do" pagesize="0" 
 requestURIcontext="false" sort="list" export="false" >
 <display:column media="html" sortable="true" title="ID" property="id" >
...
<br/>
更新日
updatedate<st:date date="${work.一般ユーザー
${artist.publicUser}
<br/>
portrait
${artist.portrait}
...
updatedate}" /><br/>
productiondate
productiondate<st:date date="${work.一般ユーザー
${artist.publicUser}
<br/>
portrait
${artist.portrait}
...
<br/>
日付
date<st:date date="${workcomment.一般ユーザー
${artist.publicUser}
<br/>
portrait
${artist.portrait}
...
</div>				<display:table name="work.workComments" id="row" requestURI=".do" pagesize="0" 
 requestURIcontext="false" sort="list" export="false" >
 <display:column media="html" sortable="true" title="ID" property="id" >
...
${row.year}
 ...
 <display:column media="html" sortable="true" title="depth">
<nobr>
${row.depth}
</nobr>
</display:column>
 <display:column media="html" sortable="true" title="information1">
<nobr>
${row.information1}
</nobr>
</display:column>
 <display:column media="html" sortable="true" title="information2">
<nobr>
${row.information2}
</nobr>
</display:column>
