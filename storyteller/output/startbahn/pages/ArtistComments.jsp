...
<tiles:insert definition=".layout">
	<tiles:put name="title" value="アーティスト・コメント一覧" direct="true" />
	<tiles:put name="content" direct="true">
<table align="right">
	<tr>
	<div>	
		<td>
			<form action="GrepArtistComment.do">
...
<c:otherwise>
<select name="artistThread" ><option value="">All</option>
...
<input type="submit" value="Go" onclick="document.publicusers1.action='PublicUsers.do'"> 
                    ...
                    <display:table name="${artistComments}" id="row" requestURI="ArtistComments.do"
                            requestURIcontext="false"
                            export="false" pagesize="30" sort="list">
                        <display:column media="html" sortable="false">
                        <a href="ShowArtistComment.do?id=${row.id}">Show</a> | 
                        <a href="PostArtistCommentDetail.do?id=${row.id}"><img src="icons/table_edit.png"></a>
                        <a href="DeleteArtistComment.do?id=${row.id}">削除</a>
                        </display:column>
