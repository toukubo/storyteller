...
<form action="SetSelectionOfPrefecture##attr##.do" method="post" name="form">
...
<span class="title">prefectures</span>
                    <display:table name="${prefectures}" id="row" requestURI="Prefectures.do"
                            requestURIcontext="false"
                            export="true" pagesize="15" sort="list">
                        <display:column media="html" sortable="false">
                        <a href="PrefectureDetail.do?id=${row.id}">ed</a>
                        <a href="DeletePrefecture.do?id=${row.id}">del</a>
                        </display:column>
...
${row.name}
                        ...
                        <a href="PrefectureDetail.do">new Prefecture</a>
<html:submit />
</form>
</div>
...
<div class="sub">
		...
		<html:form method="POST" action="/PrefectureVP">
          <html:hidden name="prefecture" property="id"/>
