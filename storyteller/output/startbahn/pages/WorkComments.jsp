...
<tiles:insert definition=".layout">
	<tiles:put name="title" value="作品コメント一覧" direct="true" />
	<tiles:put name="content" direct="true">
<table align="right">
	<tr>
	<div>	
		<td>
			<form action="GrepWorkComment.do">
...
<input type="submit" value="Go" onclick="document.publicusers1.action='PublicUsers.do'"> 
                    ...
                    <display:table name="${workComments}" id="row" requestURI="WorkComments.do"
                            requestURIcontext="false"
                            export="false" pagesize="30" sort="list">
                        <display:column media="html" sortable="false">
                        <a href="ShowWorkComment.do?id=${row.id}">Show</a> | 
                        <a href="PostWorkCommentDetail.do?id=${row.id}"><img src="icons/table_edit.png"></a>
                        <a href="DeleteWorkComment.do?id=${row.id}">削除</a>
                        </display:column>
