...
<display:column media="xml csv excel pdf" property="communityComments" title="コミュニティBBSコメント"/>
<display:column media="xml csv excel pdf" property="community" title="コミュニティ"/>
