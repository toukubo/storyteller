...
<table align="right">
	...
	<div>	
		<td>
			<form action="GrepForumComment.do">
...
<input type="submit" value="Go" onclick="document.publicusers1.action='PublicUsers.do'"> 
                    ...
                    <display:table name="${forumComments}" id="row" requestURI="ForumComments.do"
                            requestURIcontext="false"
                            export="false" pagesize="30" sort="list">
                        <display:column media="html" sortable="false">
                        <a href="ShowForumComment.do?id=${row.id}">Show</a> | 
                        <a href="PostForumCommentDetail.do?id=${row.id}"><img src="icons/table_edit.png"></a>
                        <a href="DeleteForumComment.do?id=${row.id}">削除</a>
                        </display:column>
