...
<tiles:insert definition=".layout">
	<tiles:put name="title" value="コミュニティ一覧" direct="true" />
	<tiles:put name="content" direct="true">
<table align="right">
	<tr>
	<div>	
		<td>
			<form action="GrepCommunity.do">
...
<input type="submit" value="Go" onclick="document.publicusers1.action='PublicUsers.do'"> 
                    ...
                    <display:table name="${communitys}" id="row" requestURI="Communitys.do"
                            requestURIcontext="false"
                            export="false" pagesize="30" sort="list">
                        <display:column media="html" sortable="false">
                        <a href="ShowCommunity.do?id=${row.id}">Show</a> | 
                        <a href="PostCommunityDetail.do?id=${row.id}"><img src="icons/table_edit.png"></a>
                        <a href="DeleteCommunity.do?id=${row.id}">削除</a>
                        </display:column>
