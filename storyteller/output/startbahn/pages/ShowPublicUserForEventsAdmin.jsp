...
</div>				<display:table name="event.attachments" id="row" requestURI="ForEventsAdmin.do" pagesize="0" 
...
</div>				<display:table name="publicuser.events" id="row" requestURI="ForEventsAdmin.do" pagesize="0" 
 requestURIcontext="false" sort="list" export="false" >
 <display:column media="html" sortable="true" title="ID" property="id" >
