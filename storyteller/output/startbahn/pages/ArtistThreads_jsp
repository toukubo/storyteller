...
<form action="SetSelectionOfArtistThread##attr##.do" method="post" name="form">
...
<span class="title">artistThreads</span>
                    <display:table name="${artistThreads}" id="row" requestURI="ArtistThreads.do"
                            requestURIcontext="false"
                            export="true" pagesize="15" sort="list">
                        <display:column media="html" sortable="false">
                        <a href="ArtistThreadDetail.do?id=${row.id}">ed</a>
                        <a href="DeleteArtistThread.do?id=${row.id}">del</a>
                        </display:column>
...
${row.artist.id}
 ...
 <display:column media="html" sortable="true" title="アーティスト・コメント">
<nobr>
${row.artistComments}
</nobr>
</display:column>
...
<st:date date="${row.date}" /> </nobr>
                        ...
                        <a href="ArtistThreadDetail.do">new ArtistThread</a>
<html:submit />
</form>
</div>
...
<div class="sub">
		...
		<html:form method="POST" action="/ArtistThreadVP">
          <html:hidden name="artistThread" property="id"/>
