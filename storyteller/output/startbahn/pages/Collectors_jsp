...
<tiles:insert definition=".layout">
	<tiles:put name="title" value="コレクター一覧" direct="true" />
	<tiles:put name="content" direct="true">
<table align="right">
	<tr>
	<div>	
		<td>
			<form action="GrepCollector.do">
...
<input type="submit" value="Go" onclick="document.publicusers1.action='PublicUsers.do'"> 
                    ...
                    <display:table name="${collectors}" id="row" requestURI="Collectors.do"
                            requestURIcontext="false"
                            export="false" pagesize="30" sort="list">
                        <display:column media="html" sortable="false">
                        <a href="ShowCollector.do?id=${row.id}">Show</a> | 
                        <a href="PostCollectorDetail.do?id=${row.id}"><img src="icons/table_edit.png"></a>
                        <a href="DeleteCollector.do?id=${row.id}">削除</a>
                        </display:column>
