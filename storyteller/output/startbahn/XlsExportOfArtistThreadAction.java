...
public class XlsExportOfArtistThreadAction{
	public XlsExportOfArtistThreadAction(Vector vector,OutputStream outputStream,Session session){
        ...
        try{
    		...
    		for (Iterator iter = vector.iterator(); iter.hasNext();) {
    			...
    			sheet.addCell(new Label(x++, y, artistThread.get().getTypename()));
    			sheet.addCell(new Label(x++, y, artistThread.get().getModelcode()));
    			sheet.addCell(new Label(x++, y, artistThread.get().getShimuke()));
    			sheet.addCell(new Label(x++, y, artistThread.get().getName()));
    			sheet.addCell(new Number(x++, y, artistThread.get()));
    			sheet.addCell(new Number(x++, y, artistThread.get()));
