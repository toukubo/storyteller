...
public class ActionHistoryInputRssAction extends Action{
	public ActionForward execute(
		...
		while(enum.hasMoreElements()){
		  ...
		  while(items.hasMoreElements()){
                  	RssChannelItem item = (RssChannelItem) items.nextElement();	     		                ActionHistory actionHistory = new ActionHistoryImpl();
			actionHistory.setContent(item.getItemDescription());
			actionHistory.setTitle(itemIf.getItemTitle());
