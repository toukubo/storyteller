...
public class EventGenresAction extends Action{
	public ActionForward execute(
		...
		req.setAttribute("eventGenres",criteria.list());


//		for (Iterator iter = criteria.list().iterator(); iter.hasNext();) {
//			EventGenre eventGenre = (EventGenre) iter.next();
//			vector.add(eventGenre);
//		}
		EventGenre eventGenre = new EventGenreImpl();
		EventGenreForm eventGenreform = new EventGenreForm();
		criteria = session.createCriteria(EventGenre.class);
