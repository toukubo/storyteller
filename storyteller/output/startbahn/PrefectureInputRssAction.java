...
public class PrefectureInputRssAction extends Action{
	public ActionForward execute(
		...
		while(enum.hasMoreElements()){
		  ...
		  while(items.hasMoreElements()){
                  	RssChannelItem item = (RssChannelItem) items.nextElement();	     		                Prefecture prefecture = new PrefectureImpl();
			prefecture.setContent(item.getItemDescription());
			prefecture.setTitle(itemIf.getItemTitle());
