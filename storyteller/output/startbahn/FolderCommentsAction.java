...
public class FolderCommentsAction extends Action{
	public ActionForward execute(
		...
		if (req.getParameter("id") != null
			...
			criteria2.add(Restrictions.idEq(Integer.valueOf(req
					.getParameter("id"))));
			folderComment = (FolderComment) criteria2.uniqueResult();
		...
		req.setAttribute("folderComment",folderComment);

		
		req.setAttribute("folderComments",vector);
