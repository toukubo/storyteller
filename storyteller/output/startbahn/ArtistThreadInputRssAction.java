...
public class ArtistThreadInputRssAction extends Action{
	public ActionForward execute(
		...
		while(enum.hasMoreElements()){
		  ...
		  while(items.hasMoreElements()){
                  	RssChannelItem item = (RssChannelItem) items.nextElement();	     		                ArtistThread artistThread = new ArtistThreadImpl();
			artistThread.setContent(item.getItemDescription());
			artistThread.setTitle(itemIf.getItemTitle());
