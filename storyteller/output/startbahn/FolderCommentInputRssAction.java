...
public class FolderCommentInputRssAction extends Action{
	public ActionForward execute(
		...
		while(enum.hasMoreElements()){
		  ...
		  while(items.hasMoreElements()){
                  	RssChannelItem item = (RssChannelItem) items.nextElement();	     		                FolderComment folderComment = new FolderCommentImpl();
			folderComment.setContent(item.getItemDescription());
			folderComment.setTitle(itemIf.getItemTitle());
