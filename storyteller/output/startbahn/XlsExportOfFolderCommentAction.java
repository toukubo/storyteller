...
public class XlsExportOfFolderCommentAction{
	public XlsExportOfFolderCommentAction(Vector vector,OutputStream outputStream,Session session){
        ...
        try{
    		...
    		for (Iterator iter = vector.iterator(); iter.hasNext();) {
    			...
    			sheet.addCell(new Label(x++, y, folderComment.get().getTypename()));
    			sheet.addCell(new Label(x++, y, folderComment.get().getModelcode()));
    			sheet.addCell(new Label(x++, y, folderComment.get().getShimuke()));
    			sheet.addCell(new Label(x++, y, folderComment.get().getName()));
    			sheet.addCell(new Number(x++, y, folderComment.get()));
    			sheet.addCell(new Number(x++, y, folderComment.get()));
