...
public class SetPrefectureNonPublicUsersAction extends Action{
	public ActionForward execute(
		...
		prefecture.setPublicUsers(false);
		session.saveOrUpdate(prefecture);
		transaction.commit();
		session.flush();


		new HTTPGetRedirection(req, res, "Prefectures.do", prefecture.getId().toString());
		return null;
	}
