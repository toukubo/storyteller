...
public class XlsExportOfFolderAction{
	public XlsExportOfFolderAction(Vector vector,OutputStream outputStream,Session session){
        ...
        try{
    		...
    		for (Iterator iter = vector.iterator(); iter.hasNext();) {
    			...
    			sheet.addCell(new Label(x++, y, folder.get().getTypename()));
    			sheet.addCell(new Label(x++, y, folder.get().getModelcode()));
    			sheet.addCell(new Label(x++, y, folder.get().getShimuke()));
    			sheet.addCell(new Label(x++, y, folder.get().getName()));
    			sheet.addCell(new Number(x++, y, folder.get()));
    			sheet.addCell(new Number(x++, y, folder.get()));
