...
public class XlsExportOfBettingAction{
	public XlsExportOfBettingAction(Vector vector,OutputStream outputStream,Session session){
        ...
        try{
    		...
    		for (Iterator iter = vector.iterator(); iter.hasNext();) {
    			...
    			sheet.addCell(new Label(x++, y, betting.get().getTypename()));
    			sheet.addCell(new Label(x++, y, betting.get().getModelcode()));
    			sheet.addCell(new Label(x++, y, betting.get().getShimuke()));
    			sheet.addCell(new Label(x++, y, betting.get().getName()));
    			sheet.addCell(new Number(x++, y, betting.get()));
    			sheet.addCell(new Number(x++, y, betting.get()));
