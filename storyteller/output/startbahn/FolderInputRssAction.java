...
public class FolderInputRssAction extends Action{
	public ActionForward execute(
		...
		while(enum.hasMoreElements()){
		  ...
		  while(items.hasMoreElements()){
                  	RssChannelItem item = (RssChannelItem) items.nextElement();	     		                Folder folder = new FolderImpl();
			folder.setContent(item.getItemDescription());
			folder.setTitle(itemIf.getItemTitle());
