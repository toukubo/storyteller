...
<form action="Attrs.do">
			...
			<c:choose>
				...
				<c:otherwise>
				<select name="noun" ><option value="">All</option>
...
<input type="submit" value="Go" onclick="document.publicusers1.action='PublicUsers.do'"> 
                    ...
                    <display:table name="${attrs}" id="row" requestURI="Attrs.do"
                        ...
                        <a href="ShowAttr.do?id=${row.id}">Show</a> | 
                        <a href="PostAttrDetail.do?id=${row.id}"><img src="images/icons/table_edit.png"></a>
                        <a href="DeleteAttr.do?id=${row.id}"><img src="images/icons/table_delete.png"></a>
                        </display:column>
 <display:column media="html" sortable="true" title="ID" property="id" >

</display:column>
 <display:column media="html" sortable="true" title="noun">
<nobr>
${row.noun.name}
</nobr>
</display:column>
