...
<display:column media="xml csv excel pdf" property="dataComponent" title="dataComponent"/>
<display:column media="xml csv excel pdf" property="pageLayout" title="pageLayout"/>
<display:column media="xml csv excel pdf" property="label" title="label"/>
