...
<display:column media="xml csv excel pdf" property="requesturi" title="requesturi"/>
<display:column media="xml csv excel pdf" property="components" title="components"/>
