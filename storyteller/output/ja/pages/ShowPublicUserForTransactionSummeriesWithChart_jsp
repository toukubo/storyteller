...
</div>				<display:table name="publicuser.accountTransactions" id="row" requestURI="ForTransactionSummeriesWithChart.do" pagesize="0" 
...
<br/>
集計
				<display:table name="publicuser.transactionSummeries" id="row" requestURI="ForTransactionSummeriesWithChart.do" pagesize="0" 
 requestURIcontext="false" sort="list" export="false" >
                        </display:table>
<br/>
地区
