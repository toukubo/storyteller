...
public class PostPublicUserVPForCharactorImageAction extends Action{
	public ActionForward execute(
		...
		PublicUserForm publicUserform = (PublicUserForm) form;
                ...
                String error = "";
                		...
                		Integer cardInt = publicUserform.getCard();
		publicUserform.setCard(null);
		...
		StringFullfiller.fullfil(publicUser);
                		Criteria criteria2 = session.createCriteria(Card.class);
		criteria2.add(Restrictions.idEq(cardInt));
		Card card = (Card) criteria2.uniqueResult();
		publicUser.setCard(card);
