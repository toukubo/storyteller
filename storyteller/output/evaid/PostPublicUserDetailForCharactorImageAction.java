...
public class PostPublicUserDetailForCharactorImageAction extends Action{
	public ActionForward execute(
		...
		req.setAttribute("form",publicUserform);
                  ...
                  Criteria criteriaCard= session.createCriteria(Card.class);
			req.setAttribute("Cards", criteriaCard.list());
