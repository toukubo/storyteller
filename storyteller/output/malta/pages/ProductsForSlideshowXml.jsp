...
${row.pub}
 ...
 <display:column media="html" sortable="true" title="thumnail">
<nobr>
${row.thumnail}
</nobr>
</display:column>
 <display:column media="html" sortable="true" title="スライドショー">
<nobr>
${row.slideshow}
</nobr>
</display:column>
...
<st:date date="${row.date}" /> </nobr>
 ...
 <display:column media="html" sortable="true" title="mainitemname">
<nobr>
${row.mainitemname}
</nobr>
</display:column>
