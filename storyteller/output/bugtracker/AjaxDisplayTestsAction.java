package net.bugtracker.web.app;

import net.bugtracker.model.*;
import net.bugtracker.beans.*;
...
Criteria criteriaAction= session.createCriteria(Action.class);
			req.setAttribute("Actions", criteriaAction.list());
