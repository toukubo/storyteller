...
private Double clndrYmd;
public void setClndrYmd(Double clndrYmd){
this.clndrYmd = clndrYmd;
}
public Double getClndrYmd(){
return this.clndrYmd;
}
...
private String fstvlKbn;
public void setFstvlKbn(String fstvlKbn){
this.fstvlKbn = fstvlKbn;
}
public String getFstvlKbn(){
return this.fstvlKbn;
}
private Double prvYearTrgtSmdYmd;
public void setPrvYearTrgtSmdYmd(Double prvYearTrgtSmdYmd){
this.prvYearTrgtSmdYmd = prvYearTrgtSmdYmd;
}
public Double getPrvYearTrgtSmdYmd(){
return this.prvYearTrgtSmdYmd;
}
private Double fsclMnthinCmltdDcnt;
public void setFsclMnthinCmltdDcnt(Double fsclMnthinCmltdDcnt){
this.fsclMnthinCmltdDcnt = fsclMnthinCmltdDcnt;
}
public Double getFsclMnthinCmltdDcnt(){
return this.fsclMnthinCmltdDcnt;
}
private Double bsnsYear;
public void setBsnsYear(Double bsnsYear){
this.bsnsYear = bsnsYear;
}
public Double getBsnsYear(){
return this.bsnsYear;
}
private Double bsnsMnth;
public void setBsnsMnth(Double bsnsMnth){
this.bsnsMnth = bsnsMnth;
}
public Double getBsnsMnth(){
return this.bsnsMnth;
}
