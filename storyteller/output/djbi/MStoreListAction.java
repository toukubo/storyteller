...
public class MStoreListAction extends Action{
	public ActionForward execute(
		...
		Criteria criteria = session.createCriteria(MStore.class);
...
//        }
		...
		req.setAttribute("mStores",criteria.list());
...
/*
		...
		<a href="MStoreList.do?currentpage=${page}">
		${page}
		</a>
		</c:forEach>
