...
public class PDFShowSupplierDeliveryRateAction extends Action{
	public ActionForward execute(
	   ...
	   cb.lineTo(this.xoffset + 300,this.max - (this.yoffset + 260));
            ...
            calendar.setTime(supplierDeliveryRate.getSubmissiondate());
            
            cb.setFontAndSize(bf,19);
            cb.showTextAligned(PdfContentByte.ALIGN_LEFT,"御見積書",this.xoffset + 230,this.max  - (this.yoffset),0);
            cb.setFontAndSize(bf, 12);
            cb.showTextAligned(PdfContentByte.ALIGN_LEFT,"見積No:　　" + supplierDeliveryRate.getId(),this.xoffset + 400,this.max - (this.yoffset + 10) ,0);
            ...
            if(supplierDeliveryRate.getCustomer()!=null){
            	cb.showTextAligned(PdfContentByte.ALIGN_LEFT,supplierDeliveryRate.getCustomer().getName(),this.xoffset ,this.max - (this.yoffset + 45) ,0);
            	cb.showTextAligned(PdfContentByte.ALIGN_LEFT,supplierDeliveryRate.getCustomer().getTitle() ,this.xoffset +200  ,this.max - (this.yoffset + 45) ,0);
            }
            if(supplierDeliveryRate.getQuickresponsible() !=null){
                cb.showTextAligned(PdfContentByte.ALIGN_LEFT,"ご担当　　　" +supplierDeliveryRate.getQuickresponsible() ,this.xoffset ,this.max - (this.yoffset + 65) ,0);
            }
            cb.showTextAligned(PdfContentByte.ALIGN_LEFT,"ご担当　　　" +supplierDeliveryRate.getCustomerresponsible() ,this.xoffset ,this.max - (this.yoffset + 65) ,0);
            cb.showTextAligned(PdfContentByte.ALIGN_LEFT,"様　　　" ,this.xoffset + 200,this.max - (this.yoffset + 65) ,0);
                    ...
                    cb.showTextAligned(PdfContentByte.ALIGN_RIGHT,"￥"+String.valueOf(numberFormat.format( supplierDeliveryRate.getNet().intValue() )) ,this.xoffset+270 ,this.max - (this.yoffset + 125) ,0);
            ...
            StringTokenizer stringTokenizer = new StringTokenizer(supplierDeliveryRate.getName(),"\r\n");
            if(stringTokenizer.countTokens()!=1){
            	...
            	cb.showTextAligned(PdfContentByte.ALIGN_LEFT,supplierDeliveryRate.getName(),this.xoffset + 95,this.max - (this.yoffset + 190) ,0);
            }
            ...
            cb.showTextAligned(PdfContentByte.ALIGN_LEFT, "期間",this.xoffset + 103,this.max - (this.yoffset + 350),0);

cb.showTextAligned(PdfContentByte.ALIGN_LEFT, "会社",this.xoffset + 103,this.max - (this.yoffset + 365),0);

cb.showTextAligned(PdfContentByte.ALIGN_LEFT, "仕入先",this.xoffset + 103,this.max - (this.yoffset + 380),0);

cb.showTextAligned(PdfContentByte.ALIGN_LEFT, "deliverynum",this.xoffset + 103,this.max - (this.yoffset + 395),0);
cb.showTextAligned(PdfContentByte.ALIGN_LEFT, new Integer(supplierdeliveryrate.getDeliverynum()).toString(),this.xoffset + 103,this.max - (this.yoffset + 395),0);

cb.showTextAligned(PdfContentByte.ALIGN_LEFT, "deliverytotal",this.xoffset + 103,this.max - (this.yoffset + 410),0);
cb.showTextAligned(PdfContentByte.ALIGN_LEFT, new Integer(supplierdeliveryrate.getDeliverytotal()).toString(),this.xoffset + 103,this.max - (this.yoffset + 410),0);

cb.showTextAligned(PdfContentByte.ALIGN_LEFT, "ordertotal",this.xoffset + 103,this.max - (this.yoffset + 425),0);
cb.showTextAligned(PdfContentByte.ALIGN_LEFT, new Integer(supplierdeliveryrate.getOrdertotal()).toString(),this.xoffset + 103,this.max - (this.yoffset + 425),0);

cb.showTextAligned(PdfContentByte.ALIGN_LEFT, "id",this.xoffset + 103,this.max - (this.yoffset + 440),0);
cb.showTextAligned(PdfContentByte.ALIGN_LEFT, supplierdeliveryrate.getId().toString(),this.xoffset + 103,this.max - (this.yoffset + 440),0);

cb.showTextAligned(PdfContentByte.ALIGN_LEFT, "注文数",this.xoffset + 103,this.max - (this.yoffset + 455),0);
cb.showTextAligned(PdfContentByte.ALIGN_LEFT, new Integer(supplierdeliveryrate.getOrdernum()).toString(),this.xoffset + 103,this.max - (this.yoffset + 455),0);
