...
public class MWeekNoListAction extends Action{
	public ActionForward execute(
		...
		Criteria criteria = session.createCriteria(MWeekNo.class);
...
//        }
		...
		req.setAttribute("mWeekNos",criteria.list());
...
/*
		...
		<a href="MWeekNoList.do?currentpage=${page}">
		${page}
		</a>
		</c:forEach>
