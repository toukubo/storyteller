...
<display:column media="xml csv excel pdf" property="supplierDeliveryRates" title="supplierDeliveryRates"/>
...
<display:column media="xml csv excel pdf" property="sSalesStoredays" title="sSalesStoredays"/>
