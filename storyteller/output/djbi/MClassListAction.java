...
public class MClassListAction extends Action{
	public ActionForward execute(
		...
		Criteria criteria = session.createCriteria(MClass.class);
...
//        }
		...
		req.setAttribute("mClasss",criteria.list());
...
/*
		...
		<a href="MClassList.do?currentpage=${page}">
		${page}
		</a>
		</c:forEach>
