...
public class TableDefinitionsAction extends Action{
...
//<snippet sentence="TableDefinitionsAction">


//                Vector vector = new Vector();
		Criteria criteria = session.createCriteria(TableDefinition.class);
                
		req.setAttribute("tableDefinitions",criteria.list());


//		for (Iterator iter = criteria.list().iterator(); iter.hasNext();) {
//			TableDefinition tableDefinition = (TableDefinition) iter.next();
//			vector.add(tableDefinition);
//		}
		TableDefinition tableDefinition = new TableDefinitionImpl();
		TableDefinitionForm tableDefinitionform = new TableDefinitionForm();
		criteria = session.createCriteria(TableDefinition.class);
...
//     		    CsvExportTableDefinitionsAction csvExportTableDefinitionsAction 
//                               = new CsvExportTableDefinitionsAction(req,session,Collection  collection);
//                }
