...
public class ColumnChioseInputRssAction extends Action{
	public ActionForward execute(
		...
		while(enum.hasMoreElements()){
		  ...
		  while(items.hasMoreElements()){
                  	RssChannelItem item = (RssChannelItem) items.nextElement();	     		                ColumnChiose columnChiose = new ColumnChioseImpl();
			columnChiose.setContent(item.getItemDescription());
			columnChiose.setTitle(itemIf.getItemTitle());
