...
public class CategoryRSSExportAction extends Action{
...
//	    		##secoundclass## ##secoundobj## = category.get##secoundclass##();
...
//	    			criteria.add(Restrictions.eq("##secoundobj##", ##secoundobj##));
	    			...
	    			ChannelIF newChannel = builder.createChannel("Categorys");
	    			...
	    			newChannel.setDescription("Categorys");
	    			...
	    			PrintWriter printWriter = new PrintWriter(new File(this.getServlet().getServletContext().getRealPath("CategoryRssExport.xml")),"utf-8");
