...
public class PostExcelTemplateVPAction extends Action{
	public ActionForward execute(
		...
		ExcelTemplateForm excelTemplateform = (ExcelTemplateForm) form;
                ...
                String error = "";
if(StringUtils.isBlank(exceltemplateform.getName())){
...
if(StringUtils.isNotBlank(error)){
	...
	return mapping.findForward("error");
		...
		new HTTPGetRedirection(req, res, "PostExcelTemplateDetail.do", excelTemplate.getId().toString());
		return null;
