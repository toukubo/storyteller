...
public class XlsExportOfCategoryAction{
	public XlsExportOfCategoryAction(Vector vector,OutputStream outputStream,Session session){
        ...
        try{
    		...
    		for (Iterator iter = vector.iterator(); iter.hasNext();) {
    			...
    			sheet.addCell(new Label(x++, y, category.get().getTypename()));
    			sheet.addCell(new Label(x++, y, category.get().getModelcode()));
    			sheet.addCell(new Label(x++, y, category.get().getShimuke()));
    			sheet.addCell(new Label(x++, y, category.get().getName()));
    			sheet.addCell(new Number(x++, y, category.get()));
    			sheet.addCell(new Number(x++, y, category.get()));
