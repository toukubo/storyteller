...
public class CategoryInputRssAction extends Action{
	public ActionForward execute(
		...
		while(enum.hasMoreElements()){
		  ...
		  while(items.hasMoreElements()){
                  	RssChannelItem item = (RssChannelItem) items.nextElement();	     		                Category category = new CategoryImpl();
			category.setContent(item.getItemDescription());
			category.setTitle(itemIf.getItemTitle());
