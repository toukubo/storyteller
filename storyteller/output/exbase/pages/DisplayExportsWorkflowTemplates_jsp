...
<display:column media="xml csv excel pdf" property="activityTemplates" title="activityTemplates"/>
<display:column media="xml csv excel pdf" property="workflows" title="workflows"/>
<display:column media="xml csv excel pdf" property="name" title="ã¯ã¼ã¯ãã­ã¼ãã³ãã¬ã¼ãå"/>
