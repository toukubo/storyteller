...
public class XlsExportOfColumnChioseAction{
	public XlsExportOfColumnChioseAction(Vector vector,OutputStream outputStream,Session session){
        ...
        try{
    		...
    		for (Iterator iter = vector.iterator(); iter.hasNext();) {
    			...
    			sheet.addCell(new Label(x++, y, columnChiose.get().getTypename()));
    			sheet.addCell(new Label(x++, y, columnChiose.get().getModelcode()));
    			sheet.addCell(new Label(x++, y, columnChiose.get().getShimuke()));
    			sheet.addCell(new Label(x++, y, columnChiose.get().getName()));
    			sheet.addCell(new Number(x++, y, columnChiose.get()));
    			sheet.addCell(new Number(x++, y, columnChiose.get()));
