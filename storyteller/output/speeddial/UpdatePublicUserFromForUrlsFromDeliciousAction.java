...
public class UpdatePublicUserFromForUrlsFromDeliciousAction extends Action{
	...
	public static void main(String[] args) {
		try {
				...
				UpdatePublicUserFromForUrlsFromDeliciousAction action = new UpdatePublicUserFromForUrlsFromDeliciousAction();
				Criteria criteria = session.createCriteria(PublicUser.class);
