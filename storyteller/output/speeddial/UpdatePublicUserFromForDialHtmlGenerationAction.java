...
public class UpdatePublicUserFromForDialHtmlGenerationAction extends Action{
	...
	public static void main(String[] args) {
		try {
				...
				UpdatePublicUserFromForDialHtmlGenerationAction action = new UpdatePublicUserFromForDialHtmlGenerationAction();
				Criteria criteria = session.createCriteria(PublicUser.class);
