...
public class UpdatePublicUserFromForUrlsFromTumblerAction extends Action{
	...
	public static void main(String[] args) {
		try {
				...
				UpdatePublicUserFromForUrlsFromTumblerAction action = new UpdatePublicUserFromForUrlsFromTumblerAction();
				Criteria criteria = session.createCriteria(PublicUser.class);
