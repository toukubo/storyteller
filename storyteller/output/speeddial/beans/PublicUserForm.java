...
{
private static final java.text.DateFormat format = new java.text.SimpleDateFormat("yyyy/MM/dd");static { format.setLenient(true); }private String phone;
...
return this.tumblraccount;
}
private String tumblrpassword;
public void setTumblrpassword(String tumblrpassword){
this.tumblrpassword = tumblrpassword;
}
public String getTumblrpassword(){
return this.tumblrpassword;
}
private String deliciousaccount;
public void setDeliciousaccount(String deliciousaccount){
this.deliciousaccount = deliciousaccount;
}
public String getDeliciousaccount(){
return this.deliciousaccount;
}
