...
${row.admin}
 ...
 <display:column media="html" sortable="true" title="tumblraccount">
<nobr>
${row.tumblraccount}
</nobr>
</display:column>
 <display:column media="html" sortable="true" title="tumblrpassword">
<nobr>
${row.tumblrpassword}
</nobr>
</display:column>
 <display:column media="html" sortable="true" title="deliciousaccount">
<nobr>
${row.deliciousaccount}
</nobr>
</display:column>
...
${row.urls}
 ...
 <display:column media="html" sortable="true" title="tofavorite ">
<nobr>
${row.tofavorite}
</nobr>
</display:column>
 <display:column media="html" sortable="true" title="fromfavorite ">
<nobr>
${row.fromfavorite}
</nobr>
</display:column>
