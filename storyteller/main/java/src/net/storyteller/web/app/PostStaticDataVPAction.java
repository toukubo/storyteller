	...
	public ActionForward execute(
		...
		if(staticDataform.getId() == null || staticDataform.getId().intValue() == 0){
			...
			staticData = (StaticData) criteria.uniqueResult();
                		...
                		staticData.setDocumentArrivedReportTemplate(staticDataform.getDocumentArrivedReportTemplate());
		staticData.setDocumentRequestTemplate(staticDataform.getDocumentRequestTemplate());
		staticData.setInforssurl(staticDataform.getInforssurl());
		staticData.setReportmail(staticDataform.getReportmail());
		staticData.setCrtmax(staticDataform.getCrtmax());
		staticData.setArpmax(staticDataform.getArpmax());
		staticData.setEclipseroot(staticDataform.getEclipseroot());
		staticData.setStorytellerbyprojectteamrate(staticDataform.getStorytellerbyprojectteamrate());
		staticData.setProjectbystorytellerrate(staticDataform.getProjectbystorytellerrate());
