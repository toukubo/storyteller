...
<tiles:insert definition=".layout">
	...
	<tiles:put name="header" value="Storys" direct="true" >
...
<div>
<span class="title">TaskTemplate一覧</span><a href="AjaxDisplayTaskTemplates.do?displayexport=true">Xls</a>

<form action="AjaxDisplayTaskTemplates.do" >
<select name="Cyclic">
...
<nobr><input size="30"  type="text" name="name" id="${row.id}_name" value="${row.name}" /></nobr>
</display:column>
 <display:column media="html" sortable="true" title="周期的">
<nobr><input size="8"  type="text" name="cyclic" id="${row.id}_cyclic" value="${row.cyclic}" /></nobr>
</display:column>
 <display:column media="html" sortable="true" title="storytellerRole">
                                <c:choose>
                                    ...
                                    <c:otherwise>
<select  name="storytellerRole" id="${row.id}_storytellerRole"><option value=""></option>
