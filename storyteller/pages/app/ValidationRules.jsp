...
<span class="title">validationrules</span>
                    <display:table name="${validationrules}" id="row" requestURI="ValidationRules.do"
                        ...
                        <a href="ValidationRules.do?id=${row.id}">ed</a>
...
<nobr>${row.template}</nobr>
                        ...
                        <a href="ValidationRules.do">new ValidationRule</a>
<html:submit />
</form>
</div>
...
template<br />
<html:textarea  name="validationrule" property="template" cols="40" rows="20"></html:textarea><br />
