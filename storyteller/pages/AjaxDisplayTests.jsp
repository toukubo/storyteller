         ...
         <script type="text/javascript">
             function ajax(num) {
				 ...
				 ajaxRequest.addFormElementsById(num + '_ajax');
		 		 ...
		 		 ajaxRequest.addFormElementsById(num + '_asnormal');
		 		 ajaxRequest.addFormElementsById(num + '_asmain');
...
${row.debugger}
 ...
 <display:column media="html" sortable="true" title="jsp">
                                <c:choose>
                                    ...
                                    <c:otherwise>
<select onblur="ajax(${row.id});" name="jsp" id="${row.id}_jsp"><option value=""></option>
