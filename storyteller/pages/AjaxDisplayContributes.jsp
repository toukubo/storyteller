...
<span class="title">貢献一覧</span>
 ...
 <display:column media="html" sortable="true" title="貢献タイプ">
                                <c:choose>
                                    ...
                                    <c:otherwise>
<select onblur="ajax(${row.id});" name="contributionType" id="${row.id}_contributionType"><option value=""></option>
...
<nobr><input size="8" onblur="ajax(${row.id});" type="text" name="validyearstart" id="${row.id}_validyearstart" value="${row.validyearstart}" /></nobr>
</display:column>
 <display:column media="html" sortable="true" title="validmonthstart">
<nobr><input size="8" onblur="ajax(${row.id});" type="text" name="validmonthstart" id="${row.id}_validmonthstart" value="${row.validmonthstart}" /></nobr>
</display:column>
...
<nobr><input size="8" onblur="ajax(${row.id});" type="text" name="validmonthend" id="${row.id}_validmonthend" value="${row.validmonthend}" /></nobr>
</display:column>
 <display:column media="html" sortable="true" title="ポイント">
<nobr><input size="8" onblur="ajax(${row.id});" type="text" name="point" id="${row.id}_point" value="${row.point}" /></nobr>
</display:column>
 <display:column media="html" sortable="true" title="validyearend">
<nobr><input size="8" onblur="ajax(${row.id});" type="text" name="validyearend" id="${row.id}_validyearend" value="${row.validyearend}" /></nobr>
</display:column>
